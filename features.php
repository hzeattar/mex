...
$txt = function(string $key) use ($lang): string {
  ...
  if ($T === null) { $T = [
    ...
    'f_copy_t'      =>['en'=>'Copy Trading','ar'=>'نسخ الصفقات','ru'=>'Копирование сделок'],
    'f_copy_p'      =>['en'=>'Follow verified signal providers with transparent win rates, drawdown stats, and one-tap subscription from $10.','ar'=>'تابع مزودي إشارات موثقين بمعدلات ربح شفافة وإحصاءات تراجع واشتراك بنقرة من 10$.','ru'=>'Следите за проверенными поставщиками сигналов с прозрачной статистикой и подпиской от $10.'],
    ...
    'cmp_r3_l'      =>['en'=>'Copy trading','ar'=>'نسخ الصفقات','ru'=>'Копи-трейдинг'],
