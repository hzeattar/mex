...
export function cleanup() {
  // Remove listeners bound to the persistent #view container to avoid accumulation.
  if (newsContainer) {
    newsContainer.removeEventListener('click', onNewsClick);
    newsContainer.removeEventListener('keydown', onNewsKeydown);
    newsContainer = null;
  }
}
