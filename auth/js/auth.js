...
(function(){
  ...
  function resolveCountryCode(value){
    ...
    const named = COUNTRY_BY_NAME[value] || COUNTRIES.find(function(c){ return c.c === value || c.d === value || c.en === value || c.n === value; });
  ...
  function handleSubmit(form, label){
    form.addEventListener('submit', function(e){
      ...
      if (label === 'register'){
        ...
        // Ensure country_code is present; otherwise use the ISO code stored in the hidden field dataset
        if (!payload.country_code) {
          const regCountry = document.getElementById('regCountry');
          payload.country_code = (regCountry && regCountry.dataset.code) || (payload.countryCode || '').replace(/[^A-Za-z0-9]/g, '');
        }
  ...
  var COUNTRIES = [
    { f:'🇦🇪', c:'AE', n:'الإمارات', en:'United Arab Emirates UAE', d:'+971' },
    { f:'🇸🇦', c:'SA', n:'السعودية', en:'Saudi Arabia KSA', d:'+966' },
    { f:'🇰🇼', c:'KW', n:'الكويت', en:'Kuwait', d:'+965' },
    { f:'🇶🇦', c:'QA', n:'قطر', en:'Qatar', d:'+974' },
    { f:'🇧🇭', c:'BH', n:'البحرين', en:'Bahrain', d:'+973' },
    { f:'🇴🇲', c:'OM', n:'عُمان', en:'Oman', d:'+968' },
    { f:'🇯🇴', c:'JO', n:'الأردن', en:'Jordan', d:'+962' },
    { f:'🇱🇧', c:'LB', n:'لبنان', en:'Lebanon', d:'+961' },
    { f:'🇪🇬', c:'EG', n:'مصر', en:'Egypt', d:'+20' },
    { f:'🇲🇦', c:'MA', n:'المغرب', en:'Morocco', d:'+212' },
    { f:'🇹🇳', c:'TN', n:'تونس', en:'Tunisia', d:'+216' },
    { f:'🇩🇿', c:'DZ', n:'الجزائر', en:'Algeria', d:'+213' },
    { f:'🇱🇾', c:'LY', n:'ليبيا', en:'Libya', d:'+218' },
    { f:'🇸🇩', c:'SD', n:'السودان', en:'Sudan', d:'+249' },
    { f:'🇾🇪', c:'YE', n:'اليمن', en:'Yemen', d:'+967' },
    { f:'🇮🇶', c:'IQ', n:'العراق', en:'Iraq', d:'+964' },
    { f:'🇸🇾', c:'SY', n:'سوريا', en:'Syria', d:'+963' },
    { f:'🇵🇸', c:'PS', n:'فلسطين', en:'Palestine', d:'+970' },
    { f:'🇲🇷', c:'MR', n:'موريتانيا', en:'Mauritania', d:'+222' },
    { f:'🇩🇯', c:'DJ', n:'جيبوتي', en:'Djibouti', d:'+253' },
    { f:'🇸🇴', c:'SO', n:'الصومال', en:'Somalia', d:'+252' },
    { f:'🇰🇲', c:'KM', n:'جزر القمر', en:'Comoros', d:'+269' },
    { f:'🇺🇸', c:'US', n:'الولايات المتحدة', en:'United States USA', d:'+1' },
    { f:'🇨🇦', c:'CA', n:'كندا', en:'Canada', d:'+1' },
    { f:'🇬🇧', c:'GB', n:'المملكة المتحدة', en:'United Kingdom UK Britain', d:'+44' },
    { f:'🇫🇷', c:'FR', n:'فرنسا', en:'France', d:'+33' },
    { f:'🇩🇪', c:'DE', n:'ألمانيا', en:'Germany', d:'+49' },
    { f:'🇮🇹', c:'IT', n:'إيطاليا', en:'Italy', d:'+39' },
    { f:'🇪🇸', c:'ES', n:'إسبانيا', en:'Spain', d:'+34' },
    { f:'🇵🇹', c:'PT', n:'البرتغال', en:'Portugal', d:'+351' },
    { f:'🇳🇱', c:'NL', n:'هولندا', en:'Netherlands', d:'+31' },
    { f:'🇧🇪', c:'BE', n:'بلجيكا', en:'Belgium', d:'+32' },
    { f:'🇨🇭', c:'CH', n:'سويسرا', en:'Switzerland', d:'+41' },
    { f:'🇦🇹', c:'AT', n:'النمسا', en:'Austria', d:'+43' },
    { f:'🇸🇪', c:'SE', n:'السويد', en:'Sweden', d:'+46' },
    { f:'🇳🇴', c:'NO', n:'النرويج', en:'Norway', d:'+47' },
    { f:'🇩🇰', c:'DK', n:'الدنمارك', en:'Denmark', d:'+45' },
    { f:'🇫🇮', c:'FI', n:'فنلندا', en:'Finland', d:'+358' },
    { f:'🇮🇸', c:'IS', n:'آيسلندا', en:'Iceland', d:'+354' },
    { f:'🇮🇪', c:'IE', n:'أيرلندا', en:'Ireland', d:'+353' },
    { f:'🇵🇱', c:'PL', n:'بولندا', en:'Poland', d:'+48' },
    { f:'🇨🇿', c:'CZ', n:'التشيك', en:'Czech Republic', d:'+420' },
    { f:'🇸🇰', c:'SK', n:'سلوفاكيا', en:'Slovakia', d:'+421' },
    { f:'🇭🇺', c:'HU', n:'المجر', en:'Hungary', d:'+36' },
    { f:'🇷🇴', c:'RO', n:'رومانيا', en:'Romania', d:'+40' },
    { f:'🇧🇬', c:'BG', n:'بلغاريا', en:'Bulgaria', d:'+359' },
    { f:'🇬🇷', c:'GR', n:'اليونان', en:'Greece', d:'+30' },
    { f:'🇨🇾', c:'CY', n:'قبرص', en:'Cyprus', d:'+357' },
    { f:'🇲🇹', c:'MT', n:'مالطا', en:'Malta', d:'+356' },
    { f:'🇸🇮', c:'SI', n:'سلوفينيا', en:'Slovenia', d:'+386' },
    { f:'🇭🇷', c:'HR', n:'كرواتيا', en:'Croatia', d:'+385' },
    { f:'🇷🇸', c:'RS', n:'صربيا', en:'Serbia', d:'+381' },
    { f:'🇧🇦', c:'BA', n:'البوسنة والهرسك', en:'Bosnia', d:'+387' },
    { f:'🇲🇰', c:'MK', n:'مقدونيا الشمالية', en:'North Macedonia', d:'+389' },
    { f:'🇦🇱', c:'AL', n:'ألبانيا', en:'Albania', d:'+355' },
    { f:'🇲🇪', c:'ME', n:'الجبل الأسود', en:'Montenegro', d:'+382' },
    { f:'🇽🇰', c:'XK', n:'كوسوفو', en:'Kosovo', d:'+383' },
    { f:'🇪🇪', c:'EE', n:'إستونيا', en:'Estonia', d:'+372' },
    { f:'🇱🇻', c:'LV', n:'لاتفيا', en:'Latvia', d:'+371' },
    { f:'🇱🇹', c:'LT', n:'ليتوانيا', en:'Lithuania', d:'+370' },
    { f:'🇧🇾', c:'BY', n:'بيلاروسيا', en:'Belarus', d:'+375' },
    { f:'🇺🇦', c:'UA', n:'أوكرانيا', en:'Ukraine', d:'+380' },
    { f:'🇲🇩', c:'MD', n:'مولدوفا', en:'Moldova', d:'+373' },
    { f:'🇷🇺', c:'RU', n:'روسيا', en:'Russia', d:'+7' },
    { f:'🇰🇿', c:'KZ', n:'كازاخستان', en:'Kazakhstan', d:'+7' },
    { f:'🇹🇷', c:'TR', n:'تركيا', en:'Turkey', d:'+90' },
    { f:'🇮🇷', c:'IR', n:'إيران', en:'Iran', d:'+98' },
    { f:'🇦🇫', c:'AF', n:'أفغانستان', en:'Afghanistan', d:'+93' },
    { f:'🇵🇰', c:'PK', n:'باكستان', en:'Pakistan', d:'+92' },
    { f:'🇮🇳', c:'IN', n:'الهند', en:'India', d:'+91' },
    { f:'🇧🇩', c:'BD', n:'بنغلاديش', en:'Bangladesh', d:'+880' },
    { f:'🇱🇰', c:'LK', n:'سريلانكا', en:'Sri Lanka', d:'+94' },
    { f:'🇲🇻', c:'MV', n:'المالديف', en:'Maldives', d:'+960' },
    { f:'🇳🇵', c:'NP', n:'نيبال', en:'Nepal', d:'+977' },
    { f:'🇧🇹', c:'BT', n:'بوتان', en:'Bhutan', d:'+975' },
    { f:'🇲🇲', c:'MM', n:'ميانمار', en:'Myanmar', d:'+95' },
    { f:'🇹🇭', c:'TH', n:'تايلاند', en:'Thailand', d:'+66' },
    { f:'🇻🇳', c:'VN', n:'فيتنام', en:'Vietnam', d:'+84' },
    { f:'🇰🇭', c:'KH', n:'كمبوديا', en:'Cambodia', d:'+855' },
    { f:'🇱🇦', c:'LA', n:'لاوس', en:'Laos', d:'+856' },
    { f:'🇲🇾', c:'MY', n:'ماليزيا', en:'Malaysia', d:'+60' },
    { f:'🇸🇬', c:'SG', n:'سنغافورة', en:'Singapore', d:'+65' },
    { f:'🇮🇩', c:'ID', n:'إندونيسيا', en:'Indonesia', d:'+62' },
    { f:'🇵🇭', c:'PH', n:'الفلبين', en:'Philippines', d:'+63' },
    { f:'🇧🇳', c:'BN', n:'بروناي', en:'Brunei', d:'+673' },
    { f:'🇹🇱', c:'TL', n:'تيمور الشرقية', en:'Timor-Leste', d:'+670' },
    { f:'🇨🇳', c:'CN', n:'الصين', en:'China', d:'+86' },
    { f:'🇭🇰', c:'HK', n:'هونغ كونغ', en:'Hong Kong', d:'+852' },
    { f:'🇲🇴', c:'MO', n:'ماكاو', en:'Macau', d:'+853' },
    { f:'🇹🇼', c:'TW', n:'تايوان', en:'Taiwan', d:'+886' },
    { f:'🇯🇵', c:'JP', n:'اليابان', en:'Japan', d:'+81' },
    { f:'🇰🇷', c:'KR', n:'كوريا الجنوبية', en:'South Korea', d:'+82' },
    { f:'🇰🇵', c:'KP', n:'كوريا الشمالية', en:'North Korea', d:'+850' },
    { f:'🇲🇳', c:'MN', n:'منغوليا', en:'Mongolia', d:'+976' },
    { f:'🇺🇿', c:'UZ', n:'أوزبكستان', en:'Uzbekistan', d:'+998' },
    { f:'🇰🇬', c:'KG', n:'قيرغيزستان', en:'Kyrgyzstan', d:'+996' },
    { f:'🇹🇯', c:'TJ', n:'طاجيكستان', en:'Tajikistan', d:'+992' },
    { f:'🇹🇲', c:'TM', n:'تركمانستان', en:'Turkmenistan', d:'+993' },
    { f:'🇦🇿', c:'AZ', n:'أذربيجان', en:'Azerbaijan', d:'+994' },
    { f:'🇦🇲', c:'AM', n:'أرمينيا', en:'Armenia', d:'+374' },
    { f:'🇬🇪', c:'GE', n:'جورجيا', en:'Georgia', d:'+995' },
    { f:'🇮🇱', c:'IL', n:'إسرائيل', en:'Israel', d:'+972' },
    { f:'🇿🇦', c:'ZA', n:'جنوب أفريقيا', en:'South Africa', d:'+27' },
    { f:'🇳🇬', c:'NG', n:'نيجيريا', en:'Nigeria', d:'+234' },
    { f:'🇰🇪', c:'KE', n:'كينيا', en:'Kenya', d:'+254' },
    { f:'🇪🇹', c:'ET', n:'إثيوبيا', en:'Ethiopia', d:'+251' },
    { f:'🇬🇭', c:'GH', n:'غانا', en:'Ghana', d:'+233' },
    { f:'🇨🇮', c:'CI', n:'ساحل العاج', en:'Cote dIvoire', d:'+225' },
    { f:'🇸🇳', c:'SN', n:'السنغال', en:'Senegal', d:'+221' },
    { f:'🇨🇲', c:'CM', n:'الكاميرون', en:'Cameroon', d:'+237' },
    { f:'🇹🇿', c:'TZ', n:'تنزانيا', en:'Tanzania', d:'+255' },
    { f:'🇺🇬', c:'UG', n:'أوغندا', en:'Uganda', d:'+256' },
    { f:'🇷🇼', c:'RW', n:'رواندا', en:'Rwanda', d:'+250' },
    { f:'🇧🇮', c:'BI', n:'بوروندي', en:'Burundi', d:'+257' },
    { f:'🇿🇼', c:'ZW', n:'زيمبابوي', en:'Zimbabwe', d:'+263' },
    { f:'🇿🇲', c:'ZM', n:'زامبيا', en:'Zambia', d:'+260' },
    { f:'🇲🇿', c:'MZ', n:'موزمبيق', en:'Mozambique', d:'+258' },
    { f:'🇲🇼', c:'MW', n:'مالاوي', en:'Malawi', d:'+265' },
    { f:'🇦🇴', c:'AO', n:'أنغولا', en:'Angola', d:'+244' },
    { f:'🇳🇦', c:'NA', n:'ناميبيا', en:'Namibia', d:'+264' },
    { f:'🇧🇼', c:'BW', n:'بوتسوانا', en:'Botswana', d:'+267' },
    { f:'🇲🇬', c:'MG', n:'مدغشقر', en:'Madagascar', d:'+261' },
    { f:'🇲🇺', c:'MU', n:'موريشيوس', en:'Mauritius', d:'+230' },
    { f:'🇸🇨', c:'SC', n:'سيشل', en:'Seychelles', d:'+248' },
    { f:'🇲🇱', c:'ML', n:'مالي', en:'Mali', d:'+223' },
    { f:'🇧🇫', c:'BF', n:'بوركينا فاسو', en:'Burkina Faso', d:'+226' },
    { f:'🇳🇪', c:'NE', n:'النيجر', en:'Niger', d:'+227' },
    { f:'🇹🇩', c:'TD', n:'تشاد', en:'Chad', d:'+235' },
    { f:'🇨🇫', c:'CF', n:'أفريقيا الوسطى', en:'Central African Republic', d:'+236' },
    { f:'🇨🇬', c:'CG', n:'الكونغو', en:'Congo', d:'+242' },
    { f:'🇨🇩', c:'CD', n:'الكونغو الديمقراطية', en:'DR Congo', d:'+243' },
    { f:'🇬🇦', c:'GA', n:'الغابون', en:'Gabon', d:'+241' },
    { f:'🇬🇶', c:'GQ', n:'غينيا الاستوائية', en:'Equatorial Guinea', d:'+240' },
    { f:'🇧🇯', c:'BJ', n:'بنين', en:'Benin', d:'+229' },
    { f:'🇹🇬', c:'TG', n:'توغو', en:'Togo', d:'+228' },
    { f:'🇬🇲', c:'GM', n:'غامبيا', en:'Gambia', d:'+220' },
    { f:'🇬🇼', c:'GW', n:'غينيا بيساو', en:'Guinea-Bissau', d:'+245' },
    { f:'🇬🇳', c:'GN', n:'غينيا', en:'Guinea', d:'+224' },
    { f:'🇸🇱', c:'SL', n:'سيراليون', en:'Sierra Leone', d:'+232' },
    { f:'🇱🇷', c:'LR', n:'ليبيريا', en:'Liberia', d:'+231' },
    { f:'🇨🇻', c:'CV', n:'الرأس الأخضر', en:'Cape Verde', d:'+238' },
    { f:'🇸🇹', c:'ST', n:'ساو تومي وبرينسيب', en:'Sao Tome', d:'+239' },
    { f:'🇪🇷', c:'ER', n:'إريتريا', en:'Eritrea', d:'+291' },
    { f:'🇸🇸', c:'SS', n:'جنوب السودان', en:'South Sudan', d:'+211' },
    { f:'🇱🇸', c:'LS', n:'ليسوتو', en:'Lesotho', d:'+266' },
    { f:'🇸🇿', c:'SZ', n:'إسواتيني', en:'Eswatini', d:'+268' },
    { f:'🇧🇷', c:'BR', n:'البرازيل', en:'Brazil', d:'+55' },
    { f:'🇦🇷', c:'AR', n:'الأرجنتين', en:'Argentina', d:'+54' },
    { f:'🇨🇱', c:'CL', n:'تشيلي', en:'Chile', d:'+56' },
    { f:'🇨🇴', c:'CO', n:'كولومبيا', en:'Colombia', d:'+57' },
    { f:'🇵🇪', c:'PE', n:'بيرو', en:'Peru', d:'+51' },
    { f:'🇻🇪', c:'VE', n:'فنزويلا', en:'Venezuela', d:'+58' },
    { f:'🇪🇨', c:'EC', n:'الإكوادور', en:'Ecuador', d:'+593' },
    { f:'🇧🇴', c:'BO', n:'بوليفيا', en:'Bolivia', d:'+591' },
    { f:'🇵🇾', c:'PY', n:'الباراغواي', en:'Paraguay', d:'+595' },
    { f:'🇺🇾', c:'UY', n:'الأوروغواي', en:'Uruguay', d:'+598' },
    { f:'🇬🇾', c:'GY', n:'غيانا', en:'Guyana', d:'+592' },
    { f:'🇸🇷', c:'SR', n:'سورينام', en:'Suriname', d:'+597' },
    { f:'🇲🇽', c:'MX', n:'المكسيك', en:'Mexico', d:'+52' },
    { f:'🇬🇹', c:'GT', n:'غواتيمالا', en:'Guatemala', d:'+502' },
    { f:'🇭🇳', c:'HN', n:'هندوراس', en:'Honduras', d:'+504' },
    { f:'🇸🇻', c:'SV', n:'السلفادور', en:'El Salvador', d:'+503' },
    { f:'🇳🇮', c:'NI', n:'نيكاراغوا', en:'Nicaragua', d:'+505' },
    { f:'🇨🇷', c:'CR', n:'كوستاريكا', en:'Costa Rica', d:'+506' },
    { f:'🇵🇦', c:'PA', n:'بنما', en:'Panama', d:'+507' },
    { f:'🇧🇿', c:'BZ', n:'بليز', en:'Belize', d:'+501' },
    { f:'🇨🇺', c:'CU', n:'كوبا', en:'Cuba', d:'+53' },
    { f:'🇩🇴', c:'DO', n:'الدومينيكان', en:'Dominican Republic', d:'+1' },
    { f:'🇭🇹', c:'HT', n:'هايتي', en:'Haiti', d:'+509' },
    { f:'🇯🇲', c:'JM', n:'جامايكا', en:'Jamaica', d:'+1' },
    { f:'🇧🇸', c:'BS', n:'الباهاما', en:'Bahamas', d:'+1' },
    { f:'🇧🇧', c:'BB', n:'بربادوس', en:'Barbados', d:'+1' },
    { f:'🇹🇹', c:'TT', n:'ترينيداد وتوباغو', en:'Trinidad', d:'+1' },
    { f:'🇵🇷', c:'PR', n:'بورتوريكو', en:'Puerto Rico', d:'+1' },
    { f:'🇦🇺', c:'AU', n:'أستراليا', en:'Australia', d:'+61' },
    { f:'🇳🇿', c:'NZ', n:'نيوزيلندا', en:'New Zealand', d:'+64' },
    { f:'🇫🇯', c:'FJ', n:'فيجي', en:'Fiji', d:'+679' },
    { f:'🇵🇬', c:'PG', n:'بابوا غينيا الجديدة', en:'Papua New Guinea', d:'+675' },
    { f:'🇸🇧', c:'SB', n:'جزر سليمان', en:'Solomon Islands', d:'+677' },
    { f:'🇻🇺', c:'VU', n:'فانواتو', en:'Vanuatu', d:'+678' },
    { f:'🇼🇸', c:'WS', n:'ساموا', en:'Samoa', d:'+685' },
    { f:'🇹🇴', c:'TO', n:'تونغا', en:'Tonga', d:'+676' },
    { f:'🇰🇮', c:'KI', n:'كيريباتي', en:'Kiribati', d:'+686' },
    { f:'🇲🇭', c:'MH', n:'جزر مارشال', en:'Marshall Islands', d:'+692' },
    { f:'🇫🇲', c:'FM', n:'ميكرونيزيا', en:'Micronesia', d:'+691' },
    { f:'🇵🇼', c:'PW', n:'بالاو', en:'Palau', d:'+680' },
    { f:'🇳🇷', c:'NR', n:'ناورو', en:'Nauru', d:'+674' },
    { f:'🇹🇻', c:'TV', n:'توفالو', en:'Tuvalu', d:'+688' }
  ];
  ...
  function initCountrySelect(prefix){
    ...
    function renderList(filter){
      ...
      COUNTRIES.forEach(function(c, idx){
        ...
        li.setAttribute('role','option');
        li.dataset.code  = c.c || flagToCountryCode(c.f) || '';
        li.dataset.value = c.c || flagToCountryCode(c.f) || '';
        li.dataset.flag  = c.f;
        li.dataset.name  = c.n;
        li.innerHTML =
          '<span class="auth-cc-opt__flag">' + c.f + '</span>' +
    ...
    list.addEventListener('click', function(e){
      ...
      valInp.value = li.dataset.code || li.dataset.value;
