...
$txt = function(string $key) use ($lang): string {
  ...
  if ($T === null) { $T = [
    ...
    'val3_p'        =>['en'=>'Continuously shipping features: AI trading bot, investment contracts, multi-language support, and more.','ar'=>'نطلق مزايا باستمرار: بوت التداول الذكي، وعقود الاستثمار، ودعم متعدد اللغات، والمزيد.','ru'=>'Постоянно выпускаем новые функции: ИИ-торговый бот, инвестиционные контракты, многоязычную поддержку и многое другое.'],
