...
<head>
  ...
  <meta name="description" content="Professional trading platform with web client area, market analytics, portfolio, funding, KYC, and admin review workflows." />
  <meta name="theme-color" content="#060A14" />
  <meta name="color-scheme" content="dark" />
  <meta name="apple-mobile-web-app-capable" content="yes" />
  <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
  <title><?php echo htmlspecialchars(site_setting('site.brand', 'VertexPluse'), ENT_QUOTES); ?> • Trading Platform</title>
