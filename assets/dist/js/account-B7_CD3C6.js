import{j as l,k as r,t as a,g as t,m as o,h as y}from"./main-MqBaq7k6.js";function D(){const e=l("user")||{},c=l("kyc")||{},s=l("level")||{},$=l("wallet")||{},f=l("brand")||{},k=l("support")||{},i=l("mode")==="real"?"real":"demo",n=i==="real"?$.real||{}:$.demo||{},p=s.current||e.user_level||{},u=s.next||e.next_level||null,v=Number(s.confirmed_deposit_total??e.confirmed_deposit_total??0),d=Number(u?.min_deposit_total||0),S=d>0?Math.min(100,Math.round(v/d*100)):100,x=d>0?Math.max(0,d-v):0,h=e.display_name||e.name||e.username||e.email||"Client",A=String(h).trim().charAt(0).toUpperCase()||"U",b=String(c.status||"not submitted").replace(/_/g," "),g=f.whatsapp_support_url||k.whatsapp_url||"",_=/^https?:\/\//i.test(String(g));return`
