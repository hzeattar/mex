import{j as g,k as V,g as f,t as n,h as x,m as y,e as E,r as ie,c as $,s as L,S as de,L as J,b as X,p as W,n as ue,o as Y}from"./main-DhOMcNbC.js";import{marketIconPath as pe,marketInitial as me}from"./marketIcon-D-Yq8Sis.js";let N=null,q=[];const re=[{code:"USD",flag:"🇺🇸",name:"US Dollar"},{code:"EGP",flag:"🇪🇬",name:"Egyptian Pound"},{code:"SAR",flag:"🇸🇦",name:"Saudi Riyal"},{code:"AED",flag:"🇦🇪",name:"UAE Dirham"},{code:"KWD",flag:"🇰🇼",name:"Kuwaiti Dinar"},{code:"QAR",flag:"🇶🇦",name:"Qatari Riyal"},{code:"BHD",flag:"🇧🇭",name:"Bahraini Dinar"},{code:"OMR",flag:"🇴🇲",name:"Omani Rial"},{code:"JOD",flag:"🇯🇴",name:"Jordanian Dinar"},{code:"TRY",flag:"🇹🇷",name:"Turkish Lira"},{code:"EUR",flag:"🇪🇺",name:"Euro"},{code:"GBP",flag:"🇬🇧",name:"British Pound"}];function je(){const e=g("brand")||{},t=K(),r=(g("portfolio")||{}).metrics||{},o=g("mode")==="real"?"real":"demo",s=g("level")||{},c=s.current||{},i=s.next||{},p=Number(s.confirmed_deposit_total||s.total_deposits||s.deposit_total||0),u=Number(i.min_deposit_total||i.min_total_deposit||i.required_deposit||0),h=Math.max(0,u-p),l=u>0?Math.min(100,Math.round(p/u*100)):p>0?100:0,m=Number(t.balance||t.available||0),d=Number(r.total_balance??m),v=Number(r.available_balance??t.available??d??0),b=Number(r.in_use_balance??t.holds??t.locked??0),_=Number(r.pnl_24_live??0),k=Number(r.pnl_total_live??0),S=c.name||c.name_en||c.level_code||"Starter";return i.name||i.name_en,`
    <div class="pro-dashboard animate-fade-in pro-dashboard-compact">
      ...
      <section class="pro-card pro-level-scroll-card">
        ...
        <div class="pro-level-rail" aria-label="Level benefits and next tiers">
          ${oe(s,{currentLevel:c,nextLevel:i,remainingToNext:h,nextRequired:u,levelProgress:l,mode:o})}
        </div>
      </section>
    ...
    <div class="copy-card__quote py-2">
      ...
      <span class="${Number(e.live_change_pct||0)>=0?"text-buy":"text-sell"}">${W(e.live_change_pct||0)}</span>
    </div>
  ...
  `).join(""),a.querySelectorAll("[data-symbol]").forEach(r=>{r.addEventListener("click",()=>ue("trade",{symbol:r.dataset.symbol,type:r.dataset.type}))}))}function O(e,t="all"){const a=Array.isArray(e.__homeAllMarkets)?e.__homeAllMarkets:[],r=String(t||"all").toLowerCase(),o=r==="commodity"?"commodities":r,c=(o==="all"?a:a.filter(p=>ge(p.type)===o)).slice(0,o==="all"?16:30),i=e.querySelector("#home-markets");if(!c.length){i&&(i.innerHTML=`<p class="pro-empty">${n("market.no_markets_available","No markets available in this desk.")}</p>`);return}ye(e,c),_e(e,c)}function ge(e){const t=String(e||"crypto").toLowerCase();return t==="commodity"?"commodities":t==="stock"?"stocks":t==="future"?"futures":t==="fx"?"forex":t}async function _e(e,t){const a=(t||[]).filter(s=>{if(!(Number(s?.price||s?.q_price||0)>0))return!0;const i=Q(s);return i==="stale"||i==="unavailable"});if(!a.length)return;const r=new Map;a.forEach(s=>{const c=String(s.symbol||"").toUpperCase(),i=s.type||"crypto";c&&(r.has(i)||r.set(i,[]),r.get(i).push(c))});const o=[];await Promise.all([...r.entries()].map(async([s,c])=>{const i=[...new Set(c)],p=s==="crypto"?30:8,u=new Set;for(let h=0;h<i.length;h+=p){const l=i.slice(h,h+p),m=await $(`/quotes.php?symbols=${encodeURIComponent(l.join(","))}&type=${encodeURIComponent(s)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:s==="crypto"?2600:3400,cacheTtl:500,cache:"no-store"}).catch(()=>null);m?.items?.length&&m.items.forEach(d=>{u.add(String(d.symbol||"").toUpperCase()),z(e,d,s)})}c.forEach(h=>{const l=G(e,h),m=l&&l.querySelector("[data-home-price]")?.textContent!=="--";(!u.has(h)||!m)&&o.push({symbol:h,type:s})})})),$e(e,o)}async function $e(e,t){const a=new Map;t.forEach(r=>{!r.symbol||!r.type||(a.has(r.type)||a.set(r.type,[]),a.get(r.type).push(r.symbol))});for(const[r,o]of a.entries()){const s=r==="crypto"?12:2,c=r==="crypto"?12:4,i=[...new Set(o)].slice(0,c),p=[];for(let l=0;l<i.length;l+=s){const m=i.slice(l,l+s),d=await $(`/quotes.php?symbols=${encodeURIComponent(m.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:3400,cacheTtl:500,cache:"no-store"}).catch(()=>null);d?.items?.length&&d.items.forEach(v=>z(e,v,r)),m.forEach(v=>{const b=G(e,v);b&&b.querySelector("[data-home-price]")?.textContent!=="--"||p.push(v)})}const u=r==="crypto"?6:2,h=[...new Set(p)].slice(0,r==="crypto"?6:2);for(let l=0;l<h.length;l+=u){const m=h.slice(l,l+u),d=await $(`/quotes.php?symbols=${encodeURIComponent(m.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:3400,cacheTtl:500,cache:"no-store"}).catch(()=>null);d?.items?.length&&d.items.forEach(v=>z(e,v,r))}}}function z(e,t,a){const r=String(t.symbol||"").toUpperCase(),o=G(e,r);if(!o)return;const s=o.dataset.type||t.type||a,c=Number(t.price||t.q_price||0),i=Number(t.change_pct||t.q_change||0),p=o.querySelector("[data-home-price]"),u=o.querySelector("[data-home-change]"),h=o.querySelector("[data-home-source]");if(p&&c>0){const m=parseFloat(p.dataset.price||"0");if(p.textContent=Y(c,s),p.dataset.price=String(c),m>0&&c!==m){const d=c>m?"animate-price-up":"animate-price-down";p.classList.remove("animate-price-up","animate-price-down"),requestAnimationFrame(()=>{p.classList.add(d),setTimeout(()=>p.classList.remove(d),800)})}}u&&(u.textContent=W(i),u.className=`text-[11px] ${i>=0?"text-buy":"text-sell"}`),h&&c>0&&(h.textContent=I(t));const l=o.querySelector("[data-quote-chip]");l&&c>0&&(l.className=`status-chip ${se(t)}`,l.textContent=I(t))}function G(e,t){return[...e.querySelectorAll("[data-symbol]")].find(a=>String(a.dataset.symbol||"").toUpperCase()===String(t||"").toUpperCase())}function xe(e,t){const a=e.symbol||"--";return`<span class="${t}">
    ...
    <ul class="pro-level-benefits">
      ${u.slice(0,5).map(m=>`<li>${f(m)}</li>`).join("")}
    </ul>
