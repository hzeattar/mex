...
import{c as A,s as E,j as c,k as j,t as o,h as S,g as b,o as $,_ as dt,$ as p,a as M,m as P,p as Le,f as ct,q as Ye,d as Te}from"./main-BQgegzNP.js";import{marketIconPath as ut,marketInitial as pt}from"./marketIcon-D-Yq8Sis.js";let ae=null,V=null,D=0,R=null;const mt=2e3;let B={};function ft(e,t,s,a,r={}){if(se(),!e||!e.length)return se;const n=++D,i=Qe(e,r.maxSymbols||18);return i.length&&(!r.forcePolling&&typeof EventSource=="function"?bt(i,t,s,a,n,r):Ge(i,t,s,a,n,r)),se}function Qe(e,t){const s=Math.max(1,Number(t||18));return[...new Set((e||[]).map(a=>String(a||"").toUpperCase()).filter(Boolean))].slice(0,s)}function bt(e,t,s,a,r,n){we(),B={};const i="/api/stream/sse.php?symbols="+encodeURIComponent(e.join(","))+"&type="+encodeURIComponent(t)+"&scope=watchlist&_="+Date.now();let d=!1,u=null;const l=Math.max(5e3,Number(n.fallbackAfter||5e3)),m=()=>{r===D&&(u&&(clearTimeout(u),u=null),B={},we(),Ge(e,t,s,a,r,n))},y=()=>{u&&clearTimeout(u),u=setTimeout(m,Math.max(l+2500,8e3))};let x=setTimeout(()=>{r!==D||d||m()},Math.max(3e3,l));R=new EventSource(i,{withCredentials:!0}),R.addEventListener("open",()=>{d=!0,x&&(clearTimeout(x),x=null),y()}),R.addEventListener("snapshot",_=>{if(r===D)try{const f=JSON.parse(_.data||"[]");if(Array.isArray(f)&&f.length){const h=[];for(const k of f){const g=String(k.symbol||"").toUpperCase();g&&(B[g]=k,h.push(k))}s&&s(h)}y()}catch{}}),R.addEventListener("delta",_=>{if(r===D)try{const f=JSON.parse(_.data||"[]");if(Array.isArray(f)&&f.length){const h=[];for(const k of f){const g=String(k.symbol||"").toUpperCase();g&&(B[g]=Object.assign({},B[g]||{},k),h.push(B[g]))}s&&s(h)}y()}catch{}}),R.addEventListener("message",_=>{if(r===D)try{const f=JSON.parse(_.data||"[]");if(Array.isArray(f)&&f.length&&s){for(const h of f){const k=String(h.symbol||"").toUpperCase();k&&(B[k]=h)}s(f)}y()}catch{}}),R.addEventListener("reconnect",()=>{r===D&&m()}),R.addEventListener("error",_=>{r===D&&m()})}function Ge(e,t,s,a,r,n){Ve(),B={};const i=Math.max(1500,Number(n.interval||mt)),d=Math.max(0,Number(n.initialDelay||0)),u=Qe(e,n.maxSymbols||18),l=async()=>{if(r!==D)return;V=new AbortController;const m=Math.max(3e3,Number(n.timeout||1e4)),y=setTimeout(()=>{try{V?.abort()}catch{}},m);try{const x="/quote_focus.php?symbols="+encodeURIComponent(u.join(","))+"&type="+encodeURIComponent(t),_=await A(x,{timeout:m,retry:0,cacheTtl:0,cache:"no-store",signal:V.signal});r===D&&_&&_.items&&s&&s(_.items)}catch(x){x.name}finally{clearTimeout(y),r===D&&(ae=setTimeout(l,i))}};ae=setTimeout(l,d)}function Ve(){ae&&(clearTimeout(ae),ae=null),V&&(V.abort(),V=null)}function we(){R&&(R.close(),R=null)}function se(){D+=1,B={},we(),Ve()}let T=null,z=null,me=null,Se=null,ke=null,I=null,ue=null,K=null,J=null,pe=null,re=null,xe=null,L=null,v=0;const Oe=new Map,_e=new Set;let oe=[],be=null;function C(e,t,s,a){oe.push(ct(e,t,s,a))}function yt(){return[{key:"favorites",label:o("market.type.favorites","المفضلة")},{key:"crypto",label:o("markets.crypto","الكريبتو")},{key:"forex",label:o("markets.fx","الفوركس")},{key:"stocks",label:o("markets.stocks","الأسهم")},{key:"commodities",label:o("markets.commodities","السلع")},{key:"futures",label:o("market.type.futures","العقود الآجلة")},{key:"arab",label:o("markets.arab_stocks","الأسهم العربية")}]}const Ie={crypto:[["BTCUSDT","Bitcoin / Tether"],["ETHUSDT","Ethereum / Tether"],["BNBUSDT","BNB / Tether"],["SOLUSDT","Solana / Tether"],["XRPUSDT","XRP / Tether"],["ADAUSDT","Cardano / Tether"],["DOGEUSDT","Dogecoin / Tether"],["AVAXUSDT","Avalanche / Tether"],["TRXUSDT","TRON / Tether"],["LINKUSDT","Chainlink / Tether"]],forex:[["EURUSD","Euro / US Dollar"],["GBPUSD","British Pound / US Dollar"],["USDJPY","US Dollar / Japanese Yen"],["USDCHF","US Dollar / Swiss Franc"],["AUDUSD","Australian Dollar / US Dollar"],["USDCAD","US Dollar / Canadian Dollar"],["NZDUSD","New Zealand Dollar / US Dollar"],["EURGBP","Euro / British Pound"],["EURJPY","Euro / Japanese Yen"],["GBPJPY","British Pound / Japanese Yen"]],stocks:[["AAPL","Apple Inc."],["MSFT","Microsoft Corp."],["NVDA","NVIDIA Corp."],["TSLA","Tesla Inc."],["AMZN","Amazon.com Inc."],["GOOGL","Alphabet Inc."],["META","Meta Platforms"],["NFLX","Netflix Inc."]],commodities:[["XAUUSD","Gold Spot / US Dollar"],["XAGUSD","Silver Spot / US Dollar"],["USOIL","US Oil"],["UKOIL","Brent Oil"],["NATGAS","Natural Gas"],["COPPER","Copper"]],futures:[["ES_F","S&P 500 Futures"],["NQ_F","Nasdaq 100 Futures"],["YM_F","Dow Jones Futures"],["GC_F","Gold Futures"],["CL_F","Crude Oil Futures"]],arab:[["2222","Saudi Aramco"],["1120","Al Rajhi Bank"],["2010","SABIC"],["7010","stc"],["1211","Maaden"],["1150","Alinma Bank"]]},gt=["1m","5m","15m","30m","1h","4h","1d"];function ns(e){e.symbol&&E("symbol",e.symbol.toUpperCase()),e.type&&E("type",e.type),e.tf&&E("tf",e.tf);const t=c("symbol"),s=c("type"),a=c("tf");return`<div class="trade-terminal flex flex-col lg:flex-row h-full mobile-pad">
        ...
        <div class="flex items-center gap-2 min-w-0">
          ...
          <div class="min-w-0">
            <div class="flex items-center gap-2">
              <strong class="text-sm truncate" id="sym-name">${b(t)}</strong>
            </div>
            <div class="flex items-center gap-2">
    ...
    <aside class="hidden lg:flex flex-col w-[300px] border-l border-line bg-surface shrink-0 overflow-auto">
      <div class="p-3 border-b border-line">
        ...
        <div class="text-[10px] text-muted" id="ticket-instrument">${b(t)} - ${b(s.toUpperCase())}</div>
      </div>
    ...
    <div class="grid grid-cols-2 gap-2">
      ...
      <div class="mobile-order-summary">
        <span><small>${o("trade.mode","Mode")}</small><strong>${b(c("mode")==="real"?o("trade.real","Real"):o("trade.demo","Demo"))}</strong></span>
        <span><small>${o("trade.symbol","Symbol")}</small><strong>${b(c("symbol")||"--")}</strong></span>
      ...
      <div class="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-line bg-panel px-4 py-3">
        <div class="flex items-center gap-2 min-w-0">
          ...
          <div class="min-w-0">
            ...
            <strong class="text-sm truncate" id="mobile-order-symbol">${b(e)}</strong>
          </div>
        </div>
  ...
  </div>`}function is(e){const t=s=>{if(s.target.tagName==="IMG"&&s.target.dataset.fallback==="initial"){s.target.style.display="none";const a=s.target.nextElementSibling;a&&(a.style.display="grid")}};e.addEventListener("error",t,!0),oe.push(()=>e.removeEventListener("error",t,!0)),ht(e)}function ls(){v+=1,re&&(re.disconnect(),re=null),T&&(T.remove(),T=null,z=null,me=null,L=null),I&&(I(),I=null),ye(),Je(),ve(),se(),oe.forEach(e=>{try{e()}catch{}}),oe=[],be=null,document.body.classList.remove("trade-modal-open")}async function ht(e){const t=c("symbol"),s=c("type"),a=c("tf"),r=++v;E("activeQuote",null);const n=Q();be={container:e,symbol:t,type:s,runId:r},jt(e),xt(),q(e),Ee(e,t,s,r),he(s,r).then(i=>{w(r,t,s)&&i?.items&&(e.__marketItems=i.items,W(e,i.items),Pe(e,i.items,r),setTimeout(()=>{w(r,t,s)&&ne(e,i.items,r,s)},800),ge(e,i.items,r,s).catch(()=>{}))}).catch(()=>{if(!w(r,t,s))return;const i=Ae(s);e.__marketItems=i,W(e,i)}),F(e,r),J=setInterval(()=>F(e,r,!0),2e4),ce(e,t,s,a,r,n),Ne(e,t,s,a,r,n)}function xt(){const e=()=>{if(document.hidden){ye(),Je(),I&&(I(),I=null);return}const t=be;!t||t.runId!==v||(Ee(t.container,t.symbol,t.type,t.runId),J||(F(t.container,t.runId,!0),J=setInterval(()=>F(t.container,t.runId,!0),2e4)),!I&&Array.isArray(t.container.__marketItems)&&ne(t.container,t.container.__marketItems,t.runId))};document.addEventListener("visibilitychange",e),oe.push(()=>document.removeEventListener("visibilitychange",e))}function w(e,t=c("symbol"),s=c("type")){return!(e!==v||t&&String(t).toUpperCase()!==String(c("symbol")||"").toUpperCase()||s&&U(s)!==U(c("type")))}function U(e){const t=String(e||"").toLowerCase();return t==="commodity"?"commodities":t==="stock"?"stocks":t==="future"?"futures":t}function ne(e,t,s=v,a=null){I&&(I(),I=null);const r=U(a||c("type")),n=r==="favorites"?"crypto":r,i=c("symbol"),d=n==="crypto",u=d?36:3,l=[...new Set(t.slice(0,u).map(m=>String(m.symbol||"").toUpperCase()).filter(Boolean).filter(m=>m!==String(i||"").toUpperCase()))];l.length&&(I=ft(l,n,m=>{w(s,i,c("type"))&&fe(e,m)},null,{interval:d?6e3:5e3,initialDelay:900,fallbackAfter:3e3,maxSymbols:u,timeout:9e3,forcePolling:!d}))}function Ee(e,t,s,a=v){ye();const r=U(s)==="favorites"?"crypto":U(s),n=r==="crypto"?1500:2500,i=`/quote_focus.php?symbols=${encodeURIComponent(t)}&type=${encodeURIComponent(r)}`,d=async()=>{if(w(a,t,s)){K=new AbortController;try{let u=await A(i,{timeout:2500,retry:0,signal:K.signal,cacheTtl:0,cache:"no-store"}),l=u?.items?.[0];if(!(Number(l?.price||0)>0)){const m=`/quotes.php?symbol=${encodeURIComponent(t)}&type=${encodeURIComponent(r)}&purpose=focus&_=${Date.now()}`;u=await A(m,{timeout:r==="crypto"?1800:2500,retry:0,signal:K.signal,cacheTtl:500,cache:"no-store"}),l=u?.items?.[0]}if(!w(a,t,s))return;l&&We(e,l,a)}catch{w(a,t,s)}finally{w(a,t,s)&&(ue=setTimeout(d,n))}}};d()}function ye(){ue&&(clearTimeout(ue),ue=null),K&&(K.abort(),K=null)}function Je(){J&&(clearInterval(J),J=null)}function _t(e,t,s,a=0){const r=Number(s||0),n=Number(a||0);e.__lastQuotePrices||(e.__lastQuotePrices=new Map);const i=String(t||c("symbol")||"").toUpperCase(),d=i?Number(e.__lastQuotePrices.get(i)||0):0;let u=n>0?"text-buy":n<0?"text-sell":"text-text";return d>0&&r>0&&Math.abs(r-d)>1e-12&&(u=r>d?"text-buy":"text-sell"),i&&r>0&&e.__lastQuotePrices.set(i,r),u}function $t(e){const t=String(e||"").toLowerCase();return t.includes("binance")?100:t.includes("eodhd")?94:t.includes("provider_live")?90:t.includes("yahoo_chart_live")?76:t==="yahoo"||t.includes("yahoo")?68:t.includes("frankfurter")||t.includes("stooq")||t.includes("fallback")?30:t.includes("cache")||t.includes("seed")||t.includes("reference")||t.includes("unavailable")?5:t?45:0}function Y(e){const t=Number(e||0);return t>0?t>1e12?Math.floor(t/1e3):Math.floor(t):0}function wt(e){const t=Math.max(Y(e?.provider_updated_at),Y(e?.provider_ts),Y(e?.as_of),Y(e?.updated_at)),s=Math.max(Y(e?.received_at),Y(e?.ingested_at),Y(e?.cache_updated_at));return{rank:$t(e?.source||e?.provider),providerTs:t,cacheTs:s,effectiveTs:Math.max(t,s)}}function Xe(e,t,s){if(!(Number(t?.price||t?.q_price||0)>0))return!1;e.__quoteQuality||(e.__quoteQuality=new Map);const r=String(s||t?.symbol||"").toUpperCase();if(!r)return!0;const n=wt(t),i=e.__quoteQuality.get(r);return i&&(n.providerTs>0&&i.providerTs>0&&n.providerTs+30<i.providerTs||n.effectiveTs>0&&i.effectiveTs>0&&n.effectiveTs+2<i.effectiveTs&&n.rank<=i.rank||n.rank+20<i.rank&&n.effectiveTs<=i.effectiveTs+60)?!1:(e.__quoteQuality.set(r,n),!0)}function We(e,t,s=v){if(!w(s,String(t?.symbol||c("symbol")).toUpperCase(),t?.type||c("type")))return;const a=Number(t.price||t.q_price||0);if(!Xe(e,{...t,price:a},t.symbol||c("symbol")))return;const r=Number(t.change_pct||t.q_change||0),n=c("type");E("activeQuote",{...t,price:a,change_pct:r});const i=_t(e,t.symbol||c("symbol"),a,r);fe(e,[{...t,price:a,change_pct:r}]);const d=p("#live-price",e),u=p("#live-change",e);d&&(d.textContent=a>0?$(a,n):"--",d.className=`text-xs font-mono font-bold ${i}`),u&&(u.textContent=Le(r),u.className=`text-[10px] ${r>=0?"text-buy":"text-sell"}`),M("[data-sell-price]",e).forEach(l=>{l.textContent=a>0?$(a,n):"--"}),M("[data-buy-price]",e).forEach(l=>{l.textContent=a>0?$(a*1.0001,n):"--"}),M("[data-spread-val]",e).forEach(l=>{l.textContent=a>0?`${o("trade.spread","Spread")}: ${$(a*1e-4,n)}`:`${o("trade.spread","Spread")}: --`}),q(e),Xt(a,s,Number(t.provider_updated_at||t.updated_at||t.cache_updated_at||0),U(t.type||n))}function q(e){const t=c("activeQuote")||{},s=Number(t.price||0),a=c("wallet")||{},r=c("mode")==="real"?a.real||{}:a.demo||{};M("[data-order-form]",e).forEach(n=>{const i=Number(p("[data-amount]",n)?.value||c("amount")||0),d=Number(p("[data-leverage]",n)?.value||c("leverage")||1),l=(p("[data-market-type]",n)?.value||c("market")||"spot")==="perp"?d:1,m=s>0?i*l/s:0,y=i*l,x=p("[data-lev-val]",n);x&&(x.textContent=`${d}x`);const _=p("[data-est-units]",n);_&&(_.textContent=m>0?m.toFixed(m>=10?3:6):"--");const f=p("[data-est-notional]",n);f&&(f.textContent=i>0?`${P(y)} USDT`:"--");const h=p("[data-avail-bal]",n);h&&(h.textContent=`${P(r.available||0)} ${r.currency||""}`)})}function W(e,t){const s=p("#symbol-list",e);if(!s)return;const a=c("symbol"),r=t.slice(0,120);s.innerHTML=r.map(n=>{const i=String(n.symbol||"").toUpperCase(),d=n.type||c("type"),u=Number(n.price||n.q_price||0),l=Number(n.change_pct||n.q_change||0),m=!(u>0);return`<div class="symbol-row ${i===a?"active":""}" data-sym="${S(i)}" data-stype="${S(d)}">
      ${ie(i,d,"w-7 h-7 rounded-md shrink-0")}
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-1.5">
          <div class="font-semibold text-[11px] truncate">${b(i)}</div>
        </div>
        <div class="text-[9px] text-muted truncate">${b(n.name||d)}</div>
      </div>
    ...
    </div>`}).join("")}async function ge(e,t,s=v,a=null){const r=U(a||c("type")||"crypto"),n=r==="crypto"?80:24,i=t.slice(0,n).filter(g=>!(Number(g.price||g.q_price||0)>0)).map(g=>String(g.symbol||"").toUpperCase()).filter(Boolean);if(!i.length)return;const d=r==="crypto"?24:3,u=r==="crypto"?80:24,l=r==="crypto"?4500:9e3,m=[...new Set(i)].slice(0,u),y=[],x=async g=>{const H=await A(`/quotes.php?symbols=${encodeURIComponent(g.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:Math.min(l,5e3),cacheTtl:500,cache:"no-store"}).catch(()=>null);w(s)&&(H?.items?.length&&fe(e,H.items),g.forEach(N=>{const G=M(".symbol-row",e).find(lt=>lt.dataset.sym===N);G&&p("[data-price-cell]",G)?.textContent!=="--"||y.push(N)}))},_=[];for(let g=0;g<m.length;g+=d)_.push(m.slice(g,g+d));const f=r==="crypto"?1:2;for(let g=0;g<_.length;g+=f)if(await Promise.allSettled(_.slice(g,g+f).map(x)),!w(s))return;const h=r==="crypto"?12:3,k=[...new Set(y)].slice(0,24);for(let g=0;g<k.length;g+=h){const H=k.slice(g,g+h),N=await A(`/quotes.php?symbols=${encodeURIComponent(H.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:Math.min(l,5e3),cacheTtl:500,cache:"no-store"}).catch(()=>null);if(!w(s))return;N?.items?.length&&fe(e,N.items)}}function fe(e,t){if(!t?.length)return;const s=M(".symbol-row",e);if(!s.length)return;const a=new Map;s.forEach(r=>a.set(r.dataset.sym,r)),t.forEach(r=>{const n=String(r.symbol||"").toUpperCase();if(!n)return;const i=a.get(n);if(!i)return;const d=i.dataset.stype||c("type"),u=Number(r.price||r.q_price||0);if(!(u>0)||!Xe(e,{...r,price:u},n))return;const l=Number(r.change_pct||r.q_change||0),m=p("[data-price-cell]",i),y=p("[data-change-cell]",i);m&&(m.textContent=$(u,d),m.className="text-[11px] font-mono text-text"),y&&(y.textContent=Le(l),y.className=`text-[9px] ${l>=0?"text-buy":"text-sell"}`)})}async function F(e,t=v,s=!1,a=!1){if(!w(t)||e.__tradeActivityLoading)return;e.__tradeActivityLoading=!0;const r=p("#activity-body",e);r&&!s&&!e.__tradeActivityLoaded&&(r.innerHTML='<p class="text-muted text-[11px] text-center py-4">Loading trading activity...</p>');const n=a?0:4e3,i=a?"no-store":"default",d=a?`&_=${Date.now()}`:"";try{const u=c("mode"),[l,m]=await Promise.allSettled([A(`/trade/portfolio.php?fast=1&mode=${u}${d}`,{timeout:12e3,retry:1,cacheTtl:n,cache:i}),A(`/trade/orders.php?limit=90&mode=${u}${d}`,{timeout:12e3,retry:1,cacheTtl:n,cache:i})]);if(!w(t))return;const y=l.status==="fulfilled"?l.value:null,x=m.status==="fulfilled"?m.value:null;if(y?.positions&&(e.__tradePositions=y.positions,E("portfolio",y)),(x?.items||x?.orders)&&(e.__tradeOrders=x.items||x.orders||[]),!y&&!x&&!e.__tradeActivityLoaded){r&&(r.innerHTML='<p class="text-muted text-[11px] text-center py-4">Trading activity is reconnecting...</p>');return}e.__tradeActivityLoaded=!0,Ze(e)}finally{e.__tradeActivityLoading=!1}}function Ze(e){const t=(e.__tradePositions||[]).filter(l=>!Re(l)),s=(e.__tradeOrders||[]).filter(l=>!Re(l)),a=s.filter(Ue),r=s.filter(Ce);let n=e.__tradeActivityTab||"active";(n==="positions"||n==="orders")&&(n="active"),n==="history"&&(n="closed"),e.__tradeActivityTab=n;const i=p("#active-count",e),d=p("#closed-count",e),u=p("#activity-summary",e);return i&&(i.textContent=String(t.length+a.length)),d&&(d.textContent=String(r.length)),u&&(u.textContent=`${t.length} ${o("trade.open","open")} / ${a.length} ${o("trade.pending","pending")} / ${r.length} ${o("trade.closed","closed")}`),M("[data-activity-tab]",e).forEach(l=>{l.classList.toggle("active",l.dataset.activityTab===n)}),n==="closed"?Lt(e,r):St(e,t,a)}function St(e,t,s){const a=p("#activity-body",e);if(a){if(!t.length&&!s.length){a.innerHTML=`<p class="text-muted text-[11px] text-center py-4">${o("trade.no_active_trades","No active trades yet")}</p>`;return}a.innerHTML=`
    ...
    <div class="hidden lg:block overflow-x-auto"><table class="min-w-[820px] lg:min-w-0 w-full text-[11px]">
      ...
      <tbody>${e.slice(0,16).map(Ut).join("")}</tbody>
    ...
    <td class="px-3 py-1.5 font-semibold">${b(s)}</td>
    <td>${te(i)}</td>
    ...
    <td class="text-right font-mono">${d?`${b(String(e.leverage||1))}x`:'<span class="text-muted text-[9px]">—</span>'}</td>
    ...
    <div class="flex items-start justify-between gap-2">
      <div>
        <strong>${b(s)}</strong>
        <small>${b(d?o("trade.perp_futures","Perp/Futures"):o("trade.spot","Spot"))} - ${b(e.created_at||e.opened_at||"")}</small>
      </div>
      ${te(i)}
    </div>
    <div class="trade-position-metrics">
      ...
      ${d?`<span><small>${o("trade.leverage","Leverage")}</small><strong>${b(String(e.leverage||1))}x</strong></span>`:""}
    ...
    <td class="text-right font-mono">${b(String(e.leverage||1))}x</td>
    <td class="text-right"><span class="status-chip status-chip-derived">${b(e.status||"open")}</span></td>
    <td class="text-right px-3">${tt(a,e)}</td>
  </tr>`}function Mt(e){const t=le(e),s=de(e),a=Me(e);return`<article class="trade-position-card trade-activity-card">
    <div class="flex items-start justify-between gap-2">
      <div>
        <strong>${b(Z(e))}</strong>
        <small>${b(e.order_type||"market")} - ${b(X(e.created_at))}</small>
      </div>
      ${te(t)}
    </div>
    <div class="trade-position-metrics">
      ...
      <span><small>${o("trade.lev","Lev")}</small><strong>${b(String(e.leverage||1))}x</strong></span>
      <span><small>${o("kyc.status","Status")}</small><strong>${b(e.status||o("trade.open","open"))}</strong></span>
      <span><small>${o("funding.mode","Mode")}</small><strong>${b(e.mode||c("mode")||o("mode.demo","demo"))}</strong></span>
      <span><small>${o("trade.symbol","Symbol")}</small><strong>${b(Z(e))}</strong></span>
    </div>
    ${tt(a,e,!0)}
  </article>`}function tt(e,t,s=!1){return!e||!Ue(t)?'<span class="text-muted text-[10px]">--</span>':`<div class="${s?"trade-pending-actions is-card":"trade-pending-actions"}">
    ...
    <td class="px-3 py-1.5 font-semibold">${b(Z(e))}</td>
    <td>${te(t)}</td>
    <td class="text-muted">${b(e.market_type||e.order_type||"spot")}</td>
    ...
    <td class="text-right text-muted">${b(X(e.created_at))}</td>
    <td class="text-right px-3 text-muted">${b(X(e.closed_at||e.created_at))}</td>
    ...
    <div class="flex items-start justify-between gap-2">
      <div>
        <strong>${b(Z(e))}</strong>
        <small>${b(e.close_reason||e.status||o("trade.closed","closed"))} - ${b(X(e.closed_at||e.created_at))}</small>
      </div>
      ${te(t)}
    </div>
    <div class="trade-position-metrics">
      <span><small>${o("trade.exit","Exit")}</small><strong>${$(e.exit_price||e.limit_price,s)}</strong></span>
      <span><small>${o("trade.opened","Opened")}</small><strong>${b(X(e.created_at))}</strong></span>
      <span><small>${o("trade.closed","Closed")}</small><strong>${b(X(e.closed_at||e.created_at))}</strong></span>
    ...
    <div class="chart-fallback-card">
      ...
      </div>`,document.body.appendChild(a);const r=n=>{a.remove(),t(n)};a.querySelector("[data-cancel-order-backdrop]").addEventListener("click",()=>r(!1)),a.querySelector("[data-cancel-order-no]").addEventListener("click",()=>r(!1)),a.querySelector("[data-cancel-order-yes]").addEventListener("click",()=>r(!0))})}function Qt(e,t){const s=zt(e,t);if(!s||!Ue(s)){ee(o("trade.order_no_longer_pending","This order is no longer pending."),"error"),F(e,v,!0);return}const a=de(s),r=document.getElementById("edit-order-modal");r&&r.remove();const n=document.createElement("div");n.id="edit-order-modal",n.className="fixed inset-0 z-[320] flex items-end sm:items-center justify-center",n.innerHTML=`<div class="absolute inset-0 bg-black/70" data-edit-order-backdrop></div>
    <div class="relative w-full max-w-md mx-4 mb-4 sm:mb-0 rounded-2xl border border-line bg-surface shadow-2xl overflow-hidden">
      <div class="px-5 py-4 border-b border-line">
        ...
        <p class="mt-1 text-xs text-muted">${b(Z(s))} ${b(st(le(s)))} - ${o("trade.edit_pending_copy","changes apply before execution only.")}</p>
      </div>
      ...
      <div class="relative w-full max-w-md mx-4 mb-4 sm:mb-0 bg-surface border border-line rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="px-5 py-4 space-y-3">
          <div class="flex justify-between text-sm"><span class="text-muted">${o("Symbol")}</span><strong>${b(t)}</strong></div>
          <div class="flex justify-between text-sm"><span class="text-muted">${o("Type")}</span><strong>${b(u)} / ${b(d)}</strong></div>
          ...
          <div class="flex justify-between text-sm"><span class="text-muted">${o("Mode")}</span><strong>${y==="real"?o("Real"):o("Demo")}</strong></div>
        </div>
      ...
      </div>`,document.body.appendChild(N),document.body.style.overflow="hidden";const G=De=>{N.remove(),document.body.style.overflow="",x(De)};N.querySelector("#confirm-backdrop").addEventListener("click",()=>G(!1)),N.querySelector("#confirm-cancel").addEventListener("click",()=>G(!1)),N.querySelector("#confirm-execute").addEventListener("click",()=>G(!0)),N.querySelector("#confirm-execute").focus()})}function O(e,t,s="info"){const a=p("[data-order-status]",e);a&&(a.textContent=t||"",a.hidden=!t,a.className=`order-form-status is-${s}`)}function qe(e,t){const s=[e,e.closest?.("#mobile-order-sheet")].filter(Boolean);new Set(s.flatMap(r=>M("[data-side], [data-submit-order]",r))).forEach(r=>{r.disabled=!!t,r.classList.toggle("opacity-60",!!t)}),e.classList.toggle("is-submitting",!!t)}function Kt(e){const t=p("#market-drawer",e);if(!t)return;t.classList.add("mobile-market-open"),t.classList.remove("hidden"),document.body.classList.add("trade-modal-open");const s=p("#symbol-list",e);if(s&&!s.querySelector(".symbol-row")&&!e.__marketDrawerLoading){e.__marketDrawerLoading=!0;const a=U(e.__marketDrawerType||c("type")||"crypto");e.__marketDrawerType=a,he(a,v).then(r=>{r?.items&&(e.__marketItems=r.items,W(e,r.items),Pe(e,r.items,v),ge(e,r.items,v,a))}).catch(()=>{const r=Ae(c("type"));e.__marketItems=r,W(e,r)}).finally(()=>{e.__marketDrawerLoading=!1})}}function ze(e){const t=p("#market-drawer",e);t&&(t.classList.remove("mobile-market-open"),window.innerWidth<1024&&t.classList.add("hidden"),document.body.classList.remove("trade-modal-open"))}function Jt(e,t){const s=p("#mobile-order-sheet",e);s&&(it(e,t),s.classList.remove("hidden"),document.body.classList.add("trade-modal-open"),q(e))}function nt(e){const t=p("#mobile-order-sheet",e);t&&t.classList.add("hidden"),document.body.classList.remove("trade-modal-open")}function it(e,t){const s=p("#mobile-submit-order",e),a=p("#mobile-order-side-label",e);s&&(s.dataset.submitOrder=t,s.textContent=t==="BUY"?o("trade.order.buy_now","شراء الآن"):o("trade.order.sell_now","بيع الآن"),s.className=`${t==="BUY"?"btn-buy":"btn-sell"} w-full py-3`),a&&(a.textContent=t==="BUY"?o("trade.order.buy_order","BUY order"):o("trade.order.sell_order","SELL order"))}function $e(e,t,s){M(`[data-${t}]`,e).forEach(a=>{String(a.value)!==String(s)&&(a.value=s)})}function Xt(e,t=v,s=0,a=c("type")){if(!w(t)||!z||!L||!(e>0))return;const r=Wt(s,a);r<=L.time?(L.close=e,L.high=Math.max(L.high,e),L.low=Math.min(L.low,e)):L={time:r,open:L.close,high:Math.max(L.close,e),low:Math.min(L.close,e),close:e,volume:0},z.update({time:L.time,open:L.open,high:L.high,low:L.low,close:L.close})}function Wt(e=0,t=c("type")){const s=Zt(c("tf")),a=U(t),r=Number(e||0),n=r>0&&a!=="crypto"?Math.floor(r):Math.floor(Date.now()/1e3);return Math.floor(n/s)*s}function Zt(e){return{"1m":60,"5m":300,"15m":900,"30m":1800,"1h":3600,"4h":14400,"1d":86400}[e]||60}function Q(){return xe||(xe=dt(()=>import("./chart-uI7-MQXf.js"),__vite__mapDeps([0,1]))),xe}function He(e,t){const s=[];for(let a=t-1;a<e.length;a++){let r=0;for(let n=0;n<t;n++)r+=e[a-n].close;s.push({time:e[a].time,value:r/t})}return s}function Ae(e){const t=U(e||"crypto"),s=t==="favorites"?"crypto":t||"crypto";return(Ie[s]||Ie.crypto).map(([r,n],i)=>({id:99e4+i,symbol:r,name:n,type:s,status:"active",sort_order:i+1,price:0,change_pct:0,source:"client_symbol_fallback",timing_class:"warming"}))}function es(e,t){const a=(Array.isArray(e?.items)?e.items:Array.isArray(e?.markets)?e.markets:Array.isArray(e)?e:[]).filter(r=>r&&r.symbol);return a.length?{...e||{},ok:e?.ok!==!1,items:a}:{ok:!0,items:Ae(t),fallback:"client_symbol_fallback"}}function ts(e){const t=U(e||"crypto"),s=t==="favorites"?"crypto":t,r={crypto:50,forex:30,stocks:20,commodities:20,arab:10,futures:20}[s]||20;return`/markets.php?type=${encodeURIComponent(s)}&scope=trade&supported=1&lite=1&with_quotes=1&no_rescue=1&limit=${r}`}async function he(e,t=v,s=!1){const a=U(e||"crypto"),r=a||"crypto",n=Oe.get(r),i=Date.now();if(!s&&n&&n.expires>i)return n.data;let d=null;try{d=await A(ts(a),{timeout:8e3,retry:1,cacheTtl:12e3,cache:"no-store"})}catch{if(n?.data?.items?.length)return n.data;d=null}const u=es(d,a);return w(t)&&Oe.set(r,{data:u,expires:Date.now()+8e3}),u}function Pe(e,t,s=v){const a=String(c("symbol")||"").toUpperCase(),r=(t||[]).find(i=>String(i.symbol||"").toUpperCase()===a);if(!r)return;Number(r.price||r.q_price||0)>0&&We(e,r,s)}function ss(e){const t=String(e?.timing_class||"").toLowerCase(),s=String(e?.source||"").toLowerCase();return Number(e?.price||0)<=0?"unavailable":t==="seed"||s.includes("seed")?"reference":t==="stale"||e?.is_stale?"stale":t==="market_closed"?"closed":t==="delayed"||s.includes("yahoo")||["stocks","arab"].includes(U(e?.type||c("type")))?"delayed":t==="candle_fallback"?"chart_quote":"live"}function as(e){const t=ss(e);return!["reference","stale","unavailable","chart_quote"].includes(t)}function ie(e,t,s){return`<span class="${s} grid place-items-center overflow-hidden border border-line bg-surface">
    <img src="${S(ut({symbol:e,type:t},t))}" class="h-full w-full object-cover" alt="${S(e)}" loading="lazy" data-fallback="initial" />
    <b class="hidden h-full w-full place-items-center bg-accent/20 text-[9px] font-black">${b(pt(e))}</b>
