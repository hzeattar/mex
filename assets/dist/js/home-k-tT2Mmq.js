import{o as oe,i as y,j as H,f as v,m as b,s as S,c as _,d as D,g as $,S as ne,L as V,b as Y,p as F,n as se,l as O}from"./main-CtUO7_w3.js";import{marketIconPath as ce,marketInitial as le}from"./marketIcon-D-Yq8Sis.js";let k=null;const X=[{code:"USD",flag:"🇺🇸",name:"US Dollar"},{code:"EGP",flag:"🇪🇬",name:"Egyptian Pound"},{code:"SAR",flag:"🇸🇦",name:"Saudi Riyal"},{code:"AED",flag:"🇦🇪",name:"UAE Dirham"},{code:"KWD",flag:"🇰🇼",name:"Kuwaiti Dinar"},{code:"QAR",flag:"🇶🇦",name:"Qatari Riyal"},{code:"BHD",flag:"🇧🇭",name:"Bahraini Dinar"},{code:"OMR",flag:"🇴🇲",name:"Omani Rial"},{code:"JOD",flag:"🇯🇴",name:"Jordanian Dinar"},{code:"TRY",flag:"🇹🇷",name:"Turkish Lira"},{code:"EUR",flag:"🇪🇺",name:"Euro"},{code:"GBP",flag:"🇬🇧",name:"British Pound"}];function Ie(){const e=y("brand")||{},t=G(),a=y("mode")==="real"?"real":"demo",r=y("level")||{},o=r.current||{},n=r.next||{},s=Number(r.confirmed_deposit_total||r.total_deposits||r.deposit_total||0),i=Number(n.min_deposit_total||n.min_total_deposit||n.required_deposit||0),d=Math.max(0,i-s),c=i>0?Math.min(100,Math.round(s/i*100)):s>0?100:0,p=Number(t.balance||t.available||0),l=Number(t.available||p||0),m=Number(t.holds||t.locked||0),u=o.name||o.name_en||o.level_code||"Starter";return n.name||n.name_en,`
  ...
  `).join(""),a.querySelectorAll("[data-symbol]").forEach(r=>{r.addEventListener("click",()=>se("trade",{symbol:r.dataset.symbol,type:r.dataset.type}))}))}function Z(e,t="all"){const a=Array.isArray(e.__homeAllMarkets)?e.__homeAllMarkets:[],r=String(t||"all").toLowerCase(),o=r==="commodity"?"commodities":r,s=(o==="all"?a:a.filter(d=>fe(d.type)===o)).slice(0,o==="all"?16:30),i=e.querySelector("#home-markets");if(!s.length){i&&(i.innerHTML='<p class="pro-empty">No markets available in this desk.</p>');return}ve(e,s),be(e,s)}function fe(e){const t=String(e||"crypto").toLowerCase();return t==="commodity"?"commodities":t==="stock"?"stocks":t==="future"?"futures":t==="fx"?"forex":t}async function be(e,t){const a=new Map;t.forEach(o=>{const n=String(o.symbol||"").toUpperCase(),s=o.type||"crypto";n&&(a.has(s)||a.set(s,[]),a.get(s).push(n))});const r=[];await Promise.all([...a.entries()].map(async([o,n])=>{const s=[...new Set(n)],i=o==="crypto"?30:8,d=new Set;for(let c=0;c<s.length;c+=i){const p=s.slice(c,c+i),l=await _(`/quotes.php?symbols=${encodeURIComponent(p.join(","))}&type=${encodeURIComponent(o)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:o==="crypto"?2600:3400,cacheTtl:0,cache:"no-store"}).catch(()=>null);l?.items?.length&&l.items.forEach(m=>{d.add(String(m.symbol||"").toUpperCase()),j(e,m,o)})}n.forEach(c=>{const p=z(e,c),l=p&&p.querySelector("[data-home-price]")?.textContent!=="--";(!d.has(c)||!l)&&r.push({symbol:c,type:o})})})),ye(e,r)}async function ye(e,t){const a=new Map;t.forEach(r=>{!r.symbol||!r.type||(a.has(r.type)||a.set(r.type,[]),a.get(r.type).push(r.symbol))});for(const[r,o]of a.entries()){const n=r==="crypto"?12:2,s=r==="crypto"?12:4,i=[...new Set(o)].slice(0,s),d=[];for(let l=0;l<i.length;l+=n){const m=i.slice(l,l+n),u=await _(`/quotes.php?symbols=${encodeURIComponent(m.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:3400,cacheTtl:0,cache:"no-store"}).catch(()=>null);u?.items?.length&&u.items.forEach(h=>j(e,h,r)),m.forEach(h=>{const f=z(e,h);f&&f.querySelector("[data-home-price]")?.textContent!=="--"||d.push(h)})}const c=r==="crypto"?6:2,p=[...new Set(d)].slice(0,r==="crypto"?6:2);for(let l=0;l<p.length;l+=c){const m=p.slice(l,l+c),u=await _(`/quotes.php?symbols=${encodeURIComponent(m.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:3400,cacheTtl:0,cache:"no-store"}).catch(()=>null);u?.items?.length&&u.items.forEach(h=>j(e,h,r))}}}function j(e,t,a){const r=String(t.symbol||"").toUpperCase(),o=z(e,r);if(!o)return;const n=o.dataset.type||t.type||a,s=Number(t.price||t.q_price||0),i=Number(t.change_pct||t.q_change||0),d=o.querySelector("[data-home-price]"),c=o.querySelector("[data-home-change]"),p=o.querySelector("[data-home-source]");if(d&&s>0){const m=parseFloat(d.dataset.price||"0");if(d.textContent=O(s,n),d.dataset.price=String(s),m>0&&s!==m){const u=s>m?"animate-price-up":"animate-price-down";d.classList.remove("animate-price-up","animate-price-down"),requestAnimationFrame(()=>{d.classList.add(u),setTimeout(()=>d.classList.remove(u),800)})}}c&&(c.textContent=F(i),c.className=`text-[11px] ${i>=0?"text-buy":"text-sell"}`),p&&s>0&&(p.textContent=T(t));const l=o.querySelector("[data-quote-chip]");l&&s>0&&(l.className=`status-chip ${ae(t)}`,l.textContent=T(t))}function z(e,t){return[...e.querySelectorAll("[data-symbol]")].find(a=>String(a.dataset.symbol||"").toUpperCase()===String(t||"").toUpperCase())}function ge(e,t){const a=e.symbol||"--";return`<span class="${t}">
    <img src="${$(ce(e,e.type||"crypto"))}" alt="${$(a)}" loading="lazy" data-fallback="initial" />
    <b style="display:none">${v(le(a))}</b>
  </span>`}function ee(e,t){const a=Array.isArray(e?.levels)?e.levels:[],r=t.currentLevel?.id,o=String(t.currentLevel?.level_code||"").toLowerCase(),n=M(t.currentLevel),s=a.length?a:[t.currentLevel,t.nextLevel,{name:"Platinum",min_deposit_total:t.nextRequired?t.nextRequired*2:5e4,perks:"Higher contract limits and priority support"},{name:"VIP",min_deposit_total:t.nextRequired?t.nextRequired*4:1e5,perks:"Dedicated execution review and premium limits"}].filter(Boolean),i=new Map,d=new Set,c=u=>{if(!u||typeof u!="object")return;const h=M(u);h&&d.has(h)||(h&&d.add(h),i.set(h||`level-${i.size}`,u))};s.forEach(c),c(t.currentLevel),c(t.nextLevel);const p=Array.from(i.values()).sort((u,h)=>{const f=B(u)-B(h);return Math.abs(f)>1e-7?f:Number(u.sort_order||0)-Number(h.sort_order||0)}),l=p.findIndex(u=>{if(!u||typeof u!="object")return!1;const h=r&&Number(u.id)===Number(r),f=o&&String(u.level_code||"").toLowerCase()===o,g=n&&M(u)===n;return!!(h||f||g)}),m=[];return p.forEach((u,h)=>{if(!u||typeof u!="object")return;const f=h===l||r&&Number(u.id)===Number(r)||o&&String(u.level_code||"").toLowerCase()===o||n&&M(u)===n,g=l>=0&&h<l,C=B(u),L=f?t.levelProgress:g?100:0,N=u.name||u.name_en||u.level_code||`Tier ${h+1}`,U=t.nextLevel?.name||t.nextLevel?.name_en||"next tier";m.push(_e({label:f?"Current tier":g?"Completed tier":"Locked tier",title:N,sub:f?t.nextRequired>0?`${b(t.remainingToNext)} USDT to ${U}`:"Top tier permissions are active":g?"Unlocked and completed":C>0?`${b(C)} USDT required`:"Starter access",progress:L,state:f?"current":g?"completed":"locked",perks:$e(u,xe(N,f,t.mode))}))}),m.join("")}function M(e){return String(e?.id||e?.level_code||e?.name||e?.name_en||"").toLowerCase()}function B(e){return Number(e?.min_deposit_total||e?.min_total_deposit||e?.required_deposit||0)}function _e({label:e,title:t,sub:a,progress:r,state:o,perks:n}){const s=r==null?null:Math.max(0,Math.min(100,Number(r)||0)),i=Array.isArray(n)?n:[String(n||"")].filter(Boolean);return`<article class="pro-level-rail-card is-${$(o)}">
  ...
  `).join("")}</select>
    ...
    <p id="home-fx-note">Showing account base currency</p>
      ...
      <span>${V[a]||"🏳️"}</span><b>${v(Y[a]||a.toUpperCase())}</b>
  ...
  </div>`}function Q(e){const t=e.querySelector("[data-home-lang-dropdown]"),a=e.querySelector("[data-home-lang-trigger]");t&&t.classList.add("hidden"),a&&a.setAttribute("aria-expanded","false")}function we(e,t,a,r=""){const o=e.querySelector("#home-pnl-chart-value"),n=e.querySelector("#home-pnl-spark");o&&(o.textContent=`${b(t)}${r?" "+r:""}`,o.className=t>=0?"text-buy":"text-sell"),n&&(n.innerHTML=te(t,a))}function te(e=0,t=0){const a=Number(e||0),r=Number(t||a||1),o=Array.from({length:12},(p,l)=>{const m=Math.sin((l+1)*.9)*Math.max(12,Math.abs(r)*.025);return a*(l/11)+m}),n=Math.min(...o,0),s=Math.max(...o,1),i=Math.max(1,s-n),d=o.map((p,l)=>{const m=5+l*10,u=54-(p-n)/i*44;return`${m.toFixed(1)},${u.toFixed(1)}`}).join(" "),c=a>=0?"var(--buy)":"var(--sell)";return`<svg viewBox="0 0 120 64" role="img" aria-label="PnL total chart" preserveAspectRatio="none">
