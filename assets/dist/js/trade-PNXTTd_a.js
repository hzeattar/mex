import{s as L,g as o,i as Q,e as d,b as M,$ as c,c as O,j as f,_ as Nt,d as h,n as at,a as C,m as x,p as it}from"./main-Ca1FYfWG.js";import{marketIconPath as Ut,marketInitial as Ot}from"./marketIcon-D-Yq8Sis.js";let V=null,B=null,E=0,U=null;const jt=6500;function Pt(t,e,s,a,l={}){if(A(),!t||!t.length)return A;const r=++E,n=gt(t,l.maxSymbols||18);return n.length&&(typeof EventSource=="function"?Rt(n,e,s,a,r,l):W(n,e,s,a,r,l)),A}function gt(t,e){const s=Math.max(1,Number(e||18));return[...new Set((t||[]).map(a=>String(a||"").toUpperCase()).filter(Boolean))].slice(0,s)}function Rt(t,e,s,a,l,r){R();const n="/api/stream/sse.php?symbols="+encodeURIComponent(t.join(","))+"&type="+encodeURIComponent(e)+"&scope=watchlist";let i=!1,u=setTimeout(()=>{l!==E||i||(R(),W(t,e,s,a,l,r))},Math.max(3e3,Number(r.fallbackAfter||5e3)));U=new EventSource(n,{withCredentials:!0}),U.addEventListener("open",()=>{i=!0,u&&(clearTimeout(u),u=null)}),U.addEventListener("message",p=>{if(l===E)try{const m=JSON.parse(p.data||"[]");Array.isArray(m)&&m.length&&s&&s(m)}catch{}}),U.addEventListener("reconnect",()=>{l===E&&(R(),W(t,e,s,a,l,r))}),U.addEventListener("error",p=>{l===E&&(R(),W(t,e,s,a,l,r))})}function W(t,e,s,a,l,r){vt();const n=Math.max(4e3,Number(r.interval||jt)),i=gt(t,r.maxSymbols||18),u=async()=>{if(l===E){B=new AbortController;try{const p="/api/quotes.php?symbols="+encodeURIComponent(i.join(","))+"&type="+encodeURIComponent(e)+"&visible=1&purpose=watchlist&_="+Date.now(),m=await fetch(p,{credentials:"same-origin",cache:"no-store",signal:B.signal});if(l!==E)return;if(m.ok){const b=await m.json();l===E&&b&&b.items&&s&&s(b.items)}}catch(p){p.name}finally{l===E&&(V=setTimeout(u,n))}}};u()}function vt(){V&&(clearTimeout(V),V=null),B&&(B.abort(),B=null)}function R(){U&&(U.close(),U=null)}function A(){E+=1,R(),vt()}let k=null,D=null,nt=null,dt=null,pt=null,j=null,K=null,I=null,G=null,F=null,lt=null,y=null,$=0;const At=[{key:"favorites",label:"Favorites"},{key:"crypto",label:"Crypto"},{key:"forex",label:"Forex"},{key:"stocks",label:"Stocks"},{key:"commodities",label:"Commodities"},{key:"futures",label:"Futures"},{key:"arab",label:"Arab"}],Bt=["1m","5m","15m","30m","1h","4h","1d"];function me(t){t.symbol&&L("symbol",t.symbol.toUpperCase()),t.type&&L("type",t.type),t.tf&&L("tf",t.tf);const e=o("symbol"),s=o("type"),a=o("tf");return`<div class="trade-terminal flex flex-col lg:flex-row h-full mobile-pad">
  ...
  </div>`}function be(t){t.addEventListener("error",e=>{if(e.target.tagName==="IMG"&&e.target.dataset.fallback==="initial"){e.target.style.display="none";const s=e.target.nextElementSibling;s&&(s.style.display="grid")}},!0),Ft(t)}function fe(){$+=1,F&&(F.disconnect(),F=null),k&&(k.remove(),k=null,D=null,nt=null,y=null),j&&(j(),j=null),$t(),Ht(),A(),document.body.classList.remove("trade-modal-open")}async function Ft(t){const e=o("symbol"),s=o("type"),a=o("tf"),l=++$;L("activeQuote",null);const r=Tt();ee(t),P(t),Dt(t,e,s,l),M(Et(s),{timeout:6500}).then(n=>{v(l,e,s)&&n?.items&&(wt(t,n.items),St(t,n.items,l),ht(t,n.items,l))}).catch(()=>{if(!v(l,e,s))return;const n=c("#symbol-list",t);n&&(n.innerHTML='<p class="text-muted text-[11px] text-center py-4">Markets unavailable</p>')}),J(t,l),G=setInterval(()=>J(t,l,!0),12e3),M(`/trade/candles.php?symbol=${encodeURIComponent(e)}&type=${encodeURIComponent(s)}&tf=${encodeURIComponent(a)}&limit=220`,{timeout:1e4}).then(async n=>{await r,v(l,e,s)&&(n?.items?.length?await te(t,n.items,l):c("#chart-box",t).innerHTML='<p class="text-muted text-center p-8 text-xs">Chart data unavailable</p>')}).catch(n=>{v(l,e,s)&&(console.error("Chart:",n),c("#chart-box",t).innerHTML='<p class="text-muted text-center p-8 text-xs">Chart unavailable</p>')})}function v(t,e=o("symbol"),s=o("type")){return!(t!==$||e&&String(e).toUpperCase()!==String(o("symbol")||"").toUpperCase()||s&&H(s)!==H(o("type")))}function H(t){const e=String(t||"").toLowerCase();return e==="commodity"?"commodities":e==="stock"?"stocks":e==="future"?"futures":e}function ht(t,e,s=$){j&&(j(),j=null);const a=o("type"),l=o("symbol"),r=a==="crypto"?24:12,n=[...new Set(e.slice(0,r).map(i=>String(i.symbol||"").toUpperCase()).filter(Boolean).filter(i=>i!==String(l||"").toUpperCase()))];n.length&&(j=Pt(n,a,i=>{if(!v(s,l,a))return;X(t,i);const u=c("#conn-dot",t);u&&(u.classList.remove("bg-muted","bg-sell"),u.classList.add("bg-buy"),u.title="Live")},null,{interval:a==="crypto"?5200:7200,maxSymbols:r}))}function Dt(t,e,s,a=$){$t();const l=s==="crypto"?2200:3e3,r=async()=>{if(v(a,e,s)){I=new AbortController;try{const n=`/quotes.php?symbol=${encodeURIComponent(e)}&type=${encodeURIComponent(s)}&purpose=focus`,i=await M(n,{timeout:4500,signal:I.signal});if(!v(a,e,s))return;i?.items?.[0]&&Yt(t,i.items[0],a)}catch{v(a,e,s)&&zt(t)}finally{v(a,e,s)&&(K=setTimeout(r,l))}}};r()}function $t(){K&&(clearTimeout(K),K=null),I&&(I.abort(),I=null)}function Ht(){G&&(clearInterval(G),G=null)}function zt(t){const e=c("#conn-dot",t);e&&(e.classList.remove("bg-muted","bg-buy"),e.classList.add("bg-sell"),e.title="Disconnected")}function Yt(t,e,s=$){if(!v(s,String(e?.symbol||o("symbol")).toUpperCase(),e?.type||o("type")))return;const a=Number(e.price||e.q_price||0),l=Number(e.change_pct||e.q_change||0),r=o("type");L("activeQuote",{...e,price:a,change_pct:l}),X(t,[{...e,price:a,change_pct:l}]);const n=c("#live-price",t),i=c("#live-change",t);n&&(n.textContent=a>0?f(a,r):"--"),i&&(i.textContent=it(l),i.className=`text-[10px] ${l>=0?"text-buy":"text-sell"}`);const u=c("#quote-state",t);if(u){const p=ce(e);u.textContent=p,u.className=`status-chip ${de(p)} !text-[8px] !px-1.5 !py-0.5`}C("[data-sell-price]",t).forEach(p=>{p.textContent=a>0?f(a,r):"--"}),C("[data-buy-price]",t).forEach(p=>{p.textContent=a>0?f(a*1.0001,r):"--"}),C("[data-spread-val]",t).forEach(p=>{p.textContent=a>0?`Spread: ${f(a*1e-4,r)}`:"Spread: --"}),P(t),re(a,s)}function P(t){const e=o("activeQuote")||{},s=Number(e.price||0),a=o("wallet")||{},l=o("mode")==="real"?a.real||{}:a.demo||{};C("[data-order-form]",t).forEach(r=>{const n=Number(c("[data-amount]",r)?.value||o("amount")||0),i=Number(c("[data-leverage]",r)?.value||o("leverage")||1),p=(c("[data-market-type]",r)?.value||o("market")||"spot")==="perp"?i:1,m=s>0?n*p/s:0,b=n*p,w=c("[data-lev-val]",r);w&&(w.textContent=`${i}x`);const S=c("[data-est-units]",r);S&&(S.textContent=m>0?m.toFixed(m>=10?3:6):"--");const g=c("[data-est-notional]",r);g&&(g.textContent=n>0?`${x(b)} USDT`:"--");const _=c("[data-avail-bal]",r);_&&(_.textContent=`${x(l.available||0)} ${l.currency||""}`)})}function wt(t,e){const s=c("#symbol-list",t);if(!s)return;const a=o("symbol"),l=e.slice(0,60);s.innerHTML=l.map(r=>{const n=String(r.symbol||"").toUpperCase(),i=r.type||o("type"),u=Number(r.price||r.q_price||0),p=Number(r.change_pct||r.q_change||0),m=!(u>0);return`<div class="symbol-row ${n===a?"active":""}" data-sym="${O(n)}" data-stype="${O(i)}">
      ${ot(n,i,"w-7 h-7 rounded-md shrink-0")}
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-1.5">
          <div class="font-semibold text-[11px] truncate">${d(n)}</div>
          <span class="status-dot ${m?"bg-sell":oe(r)}"></span>
        </div>
        <div class="text-[9px] text-muted truncate">${d(r.name||i)}</div>
      </div>
    ...
    </div>`}).join("")}async function St(t,e,s=$){const a=o("type"),l=e.slice(0,a==="crypto"?18:10).filter(b=>!(Number(b.price||b.q_price||0)>0)).map(b=>String(b.symbol||"").toUpperCase()).filter(Boolean);if(!l.length)return;const r=a==="crypto"?12:2,n=a==="crypto"?18:6,i=[...new Set(l)].slice(0,n),u=[];for(let b=0;b<i.length;b+=r){const w=i.slice(b,b+r),S=await M(`/quotes.php?symbols=${encodeURIComponent(w.join(","))}&type=${encodeURIComponent(a)}&cache_only=1&purpose=watchlist`,{timeout:3500}).catch(()=>null);if(!v(s))return;S?.items?.length&&X(t,S.items),w.forEach(g=>{const _=C(".symbol-row",t).find(q=>q.dataset.sym===g);_&&c("[data-price-cell]",_)?.textContent!=="--"||u.push(g)})}const p=a==="crypto"?6:2,m=[...new Set(u)].slice(0,a==="crypto"?8:3);for(let b=0;b<m.length;b+=p){const w=m.slice(b,b+p),S=await M(`/quotes.php?symbols=${encodeURIComponent(w.join(","))}&type=${encodeURIComponent(a)}&purpose=focus`,{timeout:4200}).catch(()=>null);if(!v(s))return;S?.items?.length&&X(t,S.items)}}function X(t,e){e?.length&&e.forEach(s=>{const a=String(s.symbol||"").toUpperCase();if(!a)return;const l=C(".symbol-row",t).find(m=>m.dataset.sym===a);if(!l)return;const r=l.dataset.stype||o("type"),n=Number(s.price||s.q_price||0),i=Number(s.change_pct||s.q_change||0),u=c("[data-price-cell]",l),p=c("[data-change-cell]",l);u&&n>0&&(u.textContent=f(n,r)),p&&(p.textContent=it(i),p.className=`text-[9px] ${i>=0?"text-buy":"text-sell"}`)})}async function J(t,e=$,s=!1){if(!v(e))return;const a=c("#activity-body",t);a&&!s&&!t.__tradeActivityLoaded&&(a.innerHTML='<p class="text-muted text-[11px] text-center py-4">Loading trading activity...</p>');const[l,r]=await Promise.allSettled([M("/trade/portfolio.php",{timeout:6500}),M("/trade/orders.php?limit=90",{timeout:6500})]);if(!v(e))return;const n=l.status==="fulfilled"?l.value:null,i=r.status==="fulfilled"?r.value:null;n?.positions&&(t.__tradePositions=n.positions),(i?.items||i?.orders)&&(t.__tradeOrders=i.items||i.orders||[]),t.__tradeActivityLoaded=!0,kt(t)}function kt(t){const e=t.__tradePositions||[],s=t.__tradeOrders||[],a=s.filter(m=>!ut(m)),l=s.filter(ut),r=t.__tradeActivityTab||"positions",n=c("#pos-count",t),i=c("#orders-count",t),u=c("#history-count",t),p=c("#activity-summary",t);return n&&(n.textContent=String(e.length)),i&&(i.textContent=String(a.length)),u&&(u.textContent=String(l.length)),p&&(p.textContent=`${e.length} open / ${a.length} pending / ${l.length} closed`),C("[data-activity-tab]",t).forEach(m=>{m.classList.toggle("active",m.dataset.activityTab===r)}),r==="orders"?Qt(t,a):r==="history"?Vt(t,l):qt(t,e)}function qt(t,e){const s=c("#activity-body",t);if(s){if(!e.length){s.innerHTML='<p class="text-muted text-[11px] text-center py-3">No open positions</p>';return}s.innerHTML=`
    ...
    </table></div>`}}function Lt(t){const e=Number(t.pnl||t.unrealized_pnl||0),s=String(t.symbol||"").replace("@R@",""),a=t.asset_type||o("type"),l=Number(t.mark_price||t.current_price||t.price||0),r=t.position_id||t.id||"",n=String(t.side||"buy").toUpperCase()==="SELL"?"SELL":"BUY";return{pnl:e,cleanSymbol:s,posType:a,mark:l,id:r,side:n}}function Wt(t){const{pnl:e,cleanSymbol:s,posType:a,mark:l,id:r,side:n}=Lt(t);return`<tr class="border-t border-line/50 hover:bg-panel/50">
  ...
  </tr>`}function Kt(t){const{pnl:e,cleanSymbol:s,posType:a,mark:l,id:r,side:n}=Lt(t);return`<article class="trade-position-card">
    ...
    <div class="trade-position-metrics">
      ...
      <div class="relative w-full max-w-md mx-4 mb-4 sm:mb-0 bg-surface border border-line rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="px-5 py-4 space-y-3">
          ...
          <div class="flex justify-between text-sm"><span class="text-muted">Type</span><strong>${d(u)} / ${d(i)}</strong></div>
          ...
          ${n>0?`<div class="flex justify-between text-sm"><span class="text-muted">Stop Loss</span><strong class="font-mono text-red-400">${parseFloat(n).toFixed(s==="crypto"?2:4)}</strong></div>`:""}
