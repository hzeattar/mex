import{j as _,k as V,g as b,t as n,h as S,m as y,e as E,r as ce,c as x,s as N,S as ie,L as W,b as J,p as Y,n as de,o as G}from"./main-4sNiSzdn.js";import{marketIconPath as ue,marketInitial as pe}from"./marketIcon-D-Yq8Sis.js";let q=null,D=[];const te=[{code:"USD",flag:"🇺🇸",name:"US Dollar"},{code:"EGP",flag:"🇪🇬",name:"Egyptian Pound"},{code:"SAR",flag:"🇸🇦",name:"Saudi Riyal"},{code:"AED",flag:"🇦🇪",name:"UAE Dirham"},{code:"KWD",flag:"🇰🇼",name:"Kuwaiti Dinar"},{code:"QAR",flag:"🇶🇦",name:"Qatari Riyal"},{code:"BHD",flag:"🇧🇭",name:"Bahraini Dinar"},{code:"OMR",flag:"🇴🇲",name:"Omani Rial"},{code:"JOD",flag:"🇯🇴",name:"Jordanian Dinar"},{code:"TRY",flag:"🇹🇷",name:"Turkish Lira"},{code:"EUR",flag:"🇪🇺",name:"Euro"},{code:"GBP",flag:"🇬🇧",name:"British Pound"}];function je(){const e=_("brand")||{},a=Q(),r=(_("portfolio")||{}).metrics||{},o=_("mode")==="real"?"real":"demo",s=_("level")||{},l=s.current||{},d=s.next||{},p=Number(s.confirmed_deposit_total||s.total_deposits||s.deposit_total||0),c=Number(d.min_deposit_total||d.min_total_deposit||d.required_deposit||0),m=Math.max(0,c-p),i=c>0?Math.min(100,Math.round(p/c*100)):p>0?100:0,h=Number(a.balance||a.available||0),v=Number(r.total_balance??h),u=Number(r.available_balance??a.available??v??0),f=Number(r.in_use_balance??a.holds??a.locked??0),$=Number(r.pnl_24_live??0),g=Number(r.pnl_total_live??0),k=l.name||l.name_en||l.level_code||"Starter";return d.name||d.name_en,`
    <div class="pro-dashboard animate-fade-in pro-dashboard-compact">
        ...
        <div class="pro-balance-main-row">
          <div class="pro-balance-total">
            ...
            <div class="home-pnl-chart-card hidden" id="home-pnl-chart-card">
              ...
              <div class="home-pnl-spark" id="home-pnl-spark">${re(0)}</div>
            </div>
          </div>
      ...
      <section class="pro-card pro-level-scroll-card">
        ...
        <div class="pro-level-rail" aria-label="Level benefits and next tiers">
          ${ae(s,{currentLevel:l,nextLevel:d,remainingToNext:m,nextRequired:c,levelProgress:i,mode:o})}
        </div>
      </section>
    ...
    </div>`}function Fe(e){U(e,_("portfolio")),requestAnimationFrame(()=>{const o=e.querySelector(".pro-level-rail");o&&le(o,!1)});const a=o=>{if(o.target.tagName==="IMG"&&o.target.dataset.fallback==="initial"){o.target.style.display="none";const s=o.target.nextElementSibling;s&&(s.style.display="grid")}};e.addEventListener("error",a,!0),D.push(()=>e.removeEventListener("error",a,!0)),setTimeout(()=>{e.querySelectorAll("#home-markets > *").forEach((o,s)=>{o.classList.add("stagger-item"),o.style.animationDelay=`${s*.05+.1}s`})},50);const t=o=>{const s=o.target.closest("[data-home-lang-trigger]");if(s){o.preventDefault(),o.stopPropagation();const h=s.closest("[data-home-lang-menu]")?.querySelector("[data-home-lang-dropdown]")?.classList.toggle("hidden")===!1;s.setAttribute("aria-expanded",h?"true":"false");return}const l=o.target.closest("[data-home-set-locale]");if(l){o.preventDefault(),o.stopPropagation();const m=l.dataset.homeSetLocale||l.dataset.lang;F(e),m&&m!==E()&&(l.disabled=!0,l.classList.add("is-loading"),ce(m));return}o.target.closest("[data-home-lang-menu]")||F(e);const d=o.target.closest("#home-pnl-chart-toggle");if(d){o.preventDefault();const i=e.querySelector("#home-pnl-chart-card")?.classList.toggle("hidden")===!1;d.setAttribute("aria-expanded",i?"true":"false");return}const p=o.target.closest("[data-home-tab]");if(!p)return;const c=p.dataset.homeTab;e.__homeMarketTab=c,e.querySelectorAll("[data-home-tab]").forEach(m=>{m.classList.toggle("active",m===p)}),O(e,c)};e.addEventListener("click",t),D.push(()=>e.removeEventListener("click",t));const r=o=>{const s=o.target.closest("#home-fx-select");if(!s)return;const l=M(s.value);localStorage.setItem("vp_home_currency",l),Z(e,l)};e.addEventListener("change",r),D.push(()=>e.removeEventListener("change",r)),q&&document.removeEventListener("click",q),q=o=>{e.contains(o.target)||F(e)},document.addEventListener("click",q),me(e),Z(e,I())}function Oe(){q&&(document.removeEventListener("click",q),q=null),D.forEach(e=>{try{e()}catch{}}),D=[]}async function me(e){const a=_("mode")==="real"?"real":"demo";x("/wallet/summary.php",{timeout:0,retry:1,cacheTtl:6e3}).then(t=>{(t?.real||t?.demo)&&(N("wallet",{real:t.real||{},demo:t.demo||{}}),U(e))}).catch(()=>U(e)),x(`/user/level.php?lang=${encodeURIComponent(E())}`,{timeout:0,retry:1,cacheTtl:3e4}).then(t=>{t?.ok!==!1&&(t?.current||Array.isArray(t?.levels))&&(N("level",t),he(e))}).catch(()=>null),x("/markets.php?scope=home&supported=1&lite=1&with_quotes=1&rescue=1&limit=30",{timeout:16e3,retry:1,cacheTtl:12e3}).then(t=>{if(t&&Array.isArray(t.items)&&t.items.length){e.__homeAllMarkets=t.items;const r=e.__homeMarketTab||"all";O(e,r)}else throw new Error("empty_markets")}).catch(()=>{x("/markets.php?scope=home&supported=1&lite=1&limit=30",{timeout:8e3,retry:0,cacheTtl:3e4}).then(t=>{if(t&&Array.isArray(t.items)&&t.items.length)e.__homeAllMarkets=t.items,O(e,e.__homeMarketTab||"all");else{const r=e.querySelector("#home-markets");r&&(r.innerHTML=`<p class="pro-empty">${n("market.reconnecting","Markets are reconnecting...")}</p>`)}}).catch(()=>{const t=e.querySelector("#home-markets");t&&(t.innerHTML=`<p class="pro-empty">${n("market.reconnecting","Markets are reconnecting...")}</p>`)})}),x(`/trade/portfolio.php?fast=1&mode=${a}`,{timeout:0,retry:1,cacheTtl:5e3}).then(t=>{t?.ok!==!1&&(N("portfolio",t),U(e,t))}).catch(()=>U(e)),Promise.allSettled([a==="real"?x(`/signals.php?bot=1&home=1&fast=1&lang=${encodeURIComponent(E())}`,{timeout:0,retry:1,cacheTtl:12e3}).catch(()=>null):Promise.resolve(null),x(`/invest/plans.php?kind=contract&home=1&lang=${encodeURIComponent(E())}`,{timeout:0,retry:1,cacheTtl:3e4}).catch(()=>null)]).then(([t,r])=>{const o=t.status==="fulfilled"?t.value:null,s=r.status==="fulfilled"?r.value:null;X(e,o?.items||[],s?.items||[])}).catch(()=>X(e,[],[]))}function U(e,a=_("portfolio")){const t=Q();_("mode");const r=a?.metrics||{},o=Number(t.balance||t.available||0),s=Number(r.total_balance??o),l=Number(r.available_balance??t.available??o??0),d=Number(r.in_use_balance??t.holds??t.locked??0),p=Number(r.pnl_24_live??0),c=Number(r.pnl_total_live??0);e.__homeBalanceValues={total:s,available:l,inUse:d,pnl24:p,pnlTotal:c,currency:t.currency||"USDT"},R(e)}function R(e){const a=e.__homeBalanceValues||{},t=Number(a.total||0),r=Number(a.available||0),o=Number(a.inUse||0),s=Number(a.pnl24||0),l=Number(a.pnlTotal||0),d=a.currency||Q().currency||"USDT",p=Le(),c=M(p.code),m=Number(p.rate||0)>0?Number(p.rate):1,i=B=>Number(B||0)*m,h=c==="USD"?d:c,v=e.querySelector("#home-balance-total");v&&(v.dataset.countTo=String(t),v.textContent=y(i(t),L(c)));const u=e.querySelector("#home-balance-currency");u&&(u.textContent=c==="USD"?d:`${c} - base ${d}`);const f=e.querySelector("#home-balance-available");f&&(f.textContent=`${y(i(r),L(c))} ${h}`);const $=e.querySelector("#home-balance-inuse");$&&($.textContent=`${y(i(o),L(c))} ${h}`);const g=e.querySelector("#home-pnl-24");g&&(g.textContent=`${y(i(s),L(c))} ${h}`,g.className=s>=0?"text-buy":"text-sell");const k=e.querySelector("#home-pnl-total");k&&(k.textContent=`${y(i(l),L(c))} ${h}`,k.className=l>=0?"text-buy":"text-sell");const C=e.querySelector("#home-fx-total");C&&(C.textContent=`${y(i(t),L(c))} ${h}`);const T=e.querySelector("#home-fx-rate");T&&(T.textContent=c==="USD"?`1 ${d} = 1 USD`:`1 ${d} ~= ${y(m,L(c))} ${c}`);const w=e.querySelector("#home-fx-note");if(w){const B=p.source?` - ${p.source}`:"";w.textContent=c==="USD"?"Showing account base currency":`Converted estimate${B}`,w.classList.toggle("is-error",!!p.error)}const A=e.querySelector("#home-fx-select");A&&A.value!==c&&(A.value=c),qe(e,i(l),i(s),h)}function he(e){const a=_("level")||{},t=a.current||{},r=a.next||{},o=Number(a.confirmed_deposit_total||a.total_deposits||a.deposit_total||0),s=Number(r.min_deposit_total||r.min_total_deposit||r.required_deposit||0),l=Math.max(0,s-o),d=s>0?Math.min(100,Math.round(o/s*100)):o>0?100:0,p=e.querySelector(".pro-level-scroll-card .pro-section-head h2");p&&(p.textContent=`${t.name||t.name_en||t.level_code||"Starter"} ${n("level.progress_suffix","progress")}`);const c=e.querySelector("#home-level-percent");c&&(c.textContent=`${d}%`);const m=e.querySelector("#home-level-progress");m&&(m.style.width=`${d}%`);const i=e.querySelector(".pro-level-rail");i&&(i.innerHTML=ae(a,{currentLevel:t,nextLevel:r,remainingToNext:l,nextRequired:s,levelProgress:d,mode:_("mode")==="real"?"real":"demo"}),requestAnimationFrame(()=>le(i,!0)))}function X(e,a=[],t=[]){const r=e.querySelector("#home-copy-section");if(!r)return;const o=_("mode")==="real"?"real":"demo",s=(a||[]).slice(0,6).map(ve).join(""),l=fe(t||[]);r.innerHTML=`
    ...
    <div class="copy-card__perf mt-2">
      <div class="copy-card__perf-item"><small>${n("trade.entry","Entry")}</small><strong>${ee(e.entry||e.entry_price,e.type)}</strong></div>
      ...
      <div class="copy-card__perf-item pos"><small>TP</small><strong>${ee(e.tp1||e.take_profit_1||e.take_profit,e.type)}</strong></div>
    </div>
    ...
    <a href="#/invest" class="btn-primary btn-sm w-full mt-3">${n("bot.open_copy_desk","Open copy desk")}</a>
      ...
      <small>${l>0?`${l} ${n("earn.day_term","day term")}`:n("earn.flexible_term","Flexible term")} - ${b(o)} ${n("level.level","level")}</small>
  ...
  `).join(""),t.querySelectorAll("[data-symbol]").forEach(r=>{r.addEventListener("click",()=>de("trade",{symbol:r.dataset.symbol,type:r.dataset.type}))}))}function O(e,a="all"){const t=Array.isArray(e.__homeAllMarkets)?e.__homeAllMarkets:[],r=String(a||"all").toLowerCase(),o=r==="commodity"?"commodities":r,l=(o==="all"?t:t.filter(p=>ge(p.type)===o)).slice(0,o==="all"?16:30),d=e.querySelector("#home-markets");if(!l.length){d&&(d.innerHTML=`<p class="pro-empty">${n("market.no_markets_available","No markets available in this desk.")}</p>`);return}ye(e,l),_e(e,l)}function ge(e){const a=String(e||"crypto").toLowerCase();return a==="commodity"?"commodities":a==="stock"?"stocks":a==="future"?"futures":a==="fx"?"forex":a}async function _e(e,a){const t=new Map;a.forEach(o=>{const s=String(o.symbol||"").toUpperCase(),l=o.type||"crypto";s&&(t.has(l)||t.set(l,[]),t.get(l).push(s))});const r=[];await Promise.all([...t.entries()].map(async([o,s])=>{const l=[...new Set(s)],d=o==="crypto"?30:8,p=new Set;for(let c=0;c<l.length;c+=d){const m=l.slice(c,c+d),i=await x(`/quotes.php?symbols=${encodeURIComponent(m.join(","))}&type=${encodeURIComponent(o)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:o==="crypto"?2600:3400,cacheTtl:0,cache:"no-store"}).catch(()=>null);i?.items?.length&&i.items.forEach(h=>{p.add(String(h.symbol||"").toUpperCase()),z(e,h,o)})}s.forEach(c=>{const m=K(e,c),i=m&&m.querySelector("[data-home-price]")?.textContent!=="--";(!p.has(c)||!i)&&r.push({symbol:c,type:o})})})),$e(e,r)}async function $e(e,a){const t=new Map;a.forEach(r=>{!r.symbol||!r.type||(t.has(r.type)||t.set(r.type,[]),t.get(r.type).push(r.symbol))});for(const[r,o]of t.entries()){const s=r==="crypto"?12:2,l=r==="crypto"?12:4,d=[...new Set(o)].slice(0,l),p=[];for(let i=0;i<d.length;i+=s){const h=d.slice(i,i+s),v=await x(`/quotes.php?symbols=${encodeURIComponent(h.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:3400,cacheTtl:0,cache:"no-store"}).catch(()=>null);v?.items?.length&&v.items.forEach(u=>z(e,u,r)),h.forEach(u=>{const f=K(e,u);f&&f.querySelector("[data-home-price]")?.textContent!=="--"||p.push(u)})}const c=r==="crypto"?6:2,m=[...new Set(p)].slice(0,r==="crypto"?6:2);for(let i=0;i<m.length;i+=c){const h=m.slice(i,i+c),v=await x(`/quotes.php?symbols=${encodeURIComponent(h.join(","))}&type=${encodeURIComponent(r)}&visible=1&purpose=watchlist&_=${Date.now()}`,{timeout:r==="crypto"?2600:3400,cacheTtl:0,cache:"no-store"}).catch(()=>null);v?.items?.length&&v.items.forEach(u=>z(e,u,r))}}}function z(e,a,t){const r=String(a.symbol||"").toUpperCase(),o=K(e,r);if(!o)return;const s=o.dataset.type||a.type||t,l=Number(a.price||a.q_price||0),d=Number(a.change_pct||a.q_change||0),p=o.querySelector("[data-home-price]"),c=o.querySelector("[data-home-change]"),m=o.querySelector("[data-home-source]");if(p&&l>0){const h=parseFloat(p.dataset.price||"0");if(p.textContent=G(l,s),p.dataset.price=String(l),h>0&&l!==h){const v=l>h?"animate-price-up":"animate-price-down";p.classList.remove("animate-price-up","animate-price-down"),requestAnimationFrame(()=>{p.classList.add(v),setTimeout(()=>p.classList.remove(v),800)})}}c&&(c.textContent=Y(d),c.className=`text-[11px] ${d>=0?"text-buy":"text-sell"}`),m&&l>0&&(m.textContent=P(a));const i=o.querySelector("[data-quote-chip]");i&&l>0&&(i.className=`status-chip ${ne(a)}`,i.textContent=P(a))}function K(e,a){return[...e.querySelectorAll("[data-symbol]")].find(t=>String(t.dataset.symbol||"").toUpperCase()===String(a||"").toUpperCase())}function xe(e,a){const t=e.symbol||"--";return`<span class="${a}">
    <img src="${S(ue(e,e.type||"crypto"))}" alt="${S(t)}" loading="lazy" data-fallback="initial" />
    <b style="display:none">${b(pe(t))}</b>
  </span>`}function ae(e,a){const t=Array.isArray(e?.levels)?e.levels:[],r=a.currentLevel?.id,o=String(a.currentLevel?.level_code||"").toLowerCase(),s=H(a.currentLevel),l=t.length?t:[a.currentLevel,a.nextLevel].filter(Boolean),d=new Map,p=new Set,c=u=>{if(!u||typeof u!="object")return;const f=H(u);f&&p.has(f)||(f&&p.add(f),d.set(f||`level-${d.size}`,u))};l.forEach(c),c(a.currentLevel),c(a.nextLevel);const m=Array.from(d.values()).sort((u,f)=>{const $=j(u)-j(f);return Math.abs($)>1e-7?$:Number(u.sort_order||0)-Number(f.sort_order||0)}),i=m.findIndex(u=>{if(!u||typeof u!="object")return!1;const f=r&&Number(u.id)===Number(r),$=o&&String(u.level_code||"").toLowerCase()===o,g=s&&H(u)===s;return!!(f||$||g)}),h=[],v=[];i>=0&&v.push({lvl:m[i],index:i,rel:"current"});for(let u=i+1;u<m.length;u++)v.push({lvl:m[u],index:u,rel:"after"});for(let u=i-1;u>=0;u--)v.push({lvl:m[u],index:u,rel:"before"});return v.forEach(({lvl:u,index:f,rel:$})=>{if(!u||typeof u!="object")return;const g=$==="current",k=i>=0&&f<i,C=j(u),T=g?a.levelProgress:k?100:0,w=u.name||u.name_en||u.level_code||`Tier ${f+1}`,A=a.nextLevel?.name||a.nextLevel?.name_en||"next tier";h.push(ke({label:g?n("level.current_tier","Current tier"):k?n("level.completed","Completed tier"):n("level.locked","Locked tier"),title:w,sub:g?a.nextRequired>0?`${y(a.remainingToNext)} USDT ${n("level.to_next","to")} ${A}`:n("level.top_active","Top tier permissions are active"):k?n("level.unlocked_completed","Unlocked and completed"):C>0?`${y(C)} USDT ${n("level.required","required")}`:n("level.starter_access","Starter access"),progress:T,state:g?"current":k?"completed":"locked",isCurrent:g,perks:Se(u,we(w,g,a.mode))}))}),h.join("")}function H(e){return String(e?.id||e?.level_code||e?.name||e?.name_en||"").toLowerCase()}function j(e){return Number(e?.min_deposit_total||e?.min_total_deposit||e?.required_deposit||0)}function ke({label:e,title:a,sub:t,progress:r,state:o,perks:s,isCurrent:l}){const d=r==null?null:Math.max(0,Math.min(100,Number(r)||0)),p=Array.isArray(s)?s:[String(s||"")].filter(Boolean);return`<article class="pro-level-rail-card is-${S(o)}"${l?' data-current-level-card="1"':""}>
    <div class="pro-level-card-row"><span>${b(e)}</span>${d==null?"":`<b>${d}%</b>`}</div>
    <strong>${b(a)}</strong>
    <small>${b(t||"")}</small>
    ${d==null?"":`<div class="pro-mini-progress"><i style="width:${d}%"></i></div>`}
    <ul class="pro-level-benefits">
      ${p.slice(0,5).map(c=>`<li>${b(c)}</li>`).join("")}
    </ul>
    ...
    <label class="home-fx-select-wrap">
      ...
      <select id="home-fx-select">${te.map(t=>`
  ...
  `).join("")}</select>
    ...
    <button class="home-lang-trigger" type="button" data-home-lang-trigger aria-expanded="false" title="Language">
      <span>${W[e]||"🏳️"}</span>
      <b>${b(J[e]||e.toUpperCase())}</b>
      <i>${V.chevronDown}</i>
    </button>
    <div class="home-lang-dropdown hidden" data-home-lang-dropdown>${a}</div>
  </div>`}function F(e){const a=e.querySelector("[data-home-lang-dropdown]"),t=e.querySelector("[data-home-lang-trigger]");a&&a.classList.add("hidden"),t&&t.setAttribute("aria-expanded","false")}function qe(e,a,t,r=""){const o=e.querySelector("#home-pnl-chart-value"),s=e.querySelector("#home-pnl-spark");o&&(o.textContent=`${y(a)}${r?" "+r:""}`,o.className=a>=0?"text-buy":"text-sell"),s&&(s.innerHTML=re(a,t))}function re(e=0,a=0){const t=Number(e||0),r=Number(a||t||1),o=Array.from({length:12},(m,i)=>{const h=Math.sin((i+1)*.9)*Math.max(12,Math.abs(r)*.025);return t*(i/11)+h}),s=Math.min(...o,0),l=Math.max(...o,1),d=Math.max(1,l-s),p=o.map((m,i)=>{const h=5+i*10,v=54-(m-s)/d*44;return`${h.toFixed(1)},${v.toFixed(1)}`}).join(" "),c=t>=0?"var(--buy)":"var(--sell)";return`<svg viewBox="0 0 120 64" role="img" aria-label="PnL total chart" preserveAspectRatio="none">
    <path d="M0 54 H120" class="home-pnl-axis"></path>
    <polyline points="${p}" fill="none" stroke="${c}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></polyline>
  ...
  </div>`}function Q(){const e=_("wallet")||{};return _("mode")==="real"?e.real||{balance:0,available:0,currency:"USDT"}:e.demo||{balance:1e4,available:1e4,currency:"USDT_DEMO"}}function Me(e,a){const t=Number(e||0);return t>0?G(t,a):"--"}function oe(e){const a=String(e.source||e.provider||"").toLowerCase(),t=String(e.timing_class||"").toLowerCase();return Number(e.price||e.q_price||0)<=0?"unavailable":t==="stale"||e.is_stale?"stale":t==="market_closed"?"closed":e.delayed||t==="delayed"||a.includes("yahoo")?"delayed":a.includes("binance")||a.includes("stream")||t==="live"?"live":"cached"}function P(e){const a=oe(e);return{live:n("quote.live","Live"),delayed:n("quote.delayed","Delayed"),stale:n("quote.stale","Stale"),closed:n("quote.closed","Closed"),unavailable:n("quote.unavailable","Unavailable"),cached:n("quote.cached","Cached")}[a]||a}function ne(e){const a=oe(e);return a==="live"?"status-chip-live":a==="unavailable"?"status-chip-locked":"status-chip-delayed"}function Ae(e){return`<span data-quote-chip class="status-chip ${ne(e)}">${P(e)}</span>`}function Ue(e){const a=String(e?.level_code||e?.name_en||"starter").toLowerCase().replace(/[^a-z0-9]+/g,"-"),t=e?.name||e?.name_en||e?.level_code||"Starter";return`<span class="level-badge level-badge--${S(a)}">${b(t)}</span>`}function Ee(e){const a=String(e||"").split("").reduce((t,r)=>t+r.charCodeAt(0),0);return Array.from({length:12},(t,r)=>`<i style="height:${18+(a+r*13)%26}px"></i>`).join("")}function ee(e,a){const t=Number(e||0);return t>0?G(t,a):"--"}function De(e){return!(Number(e.entry||e.entry_price||0)>0)||!(Number(e.tp1||e.take_profit_1||e.take_profit||0)>0)||!(Number(e.sl||e.stop_loss||0)>0)}function Re(e){return e.levels_source==="live_derived"?'<p class="text-[10px] text-spread mt-2">Live-derived desk levels</p>':""}function Pe(e){const a=String(e?.bot_name||e?.bot_name_en||"").trim();if(a)return a;const t=String(e?.symbol||e?.market_symbol||"AI").toUpperCase();return`Avalon ${t.replace(/(USDT|USD|_F)$/i,"")||t||"AI"} AI Bot`}function se(e){const a=String(e||"BUY").toUpperCase();return["BUY","SELL","NEUTRAL"].includes(a)?a:"BUY"}function Ie(e){const a=se(e);return`<span class="bot-direction-chip is-${a.toLowerCase()}">${b(a)}</span>`}function le(e,a=!1){if(!e)return;const t=e.querySelector('[data-current-level-card="1"]');if(!t)return;const r=e.getBoundingClientRect(),o=t.getBoundingClientRect(),s=e.scrollLeft+(o.left-r.left)-8;a?e.scrollTo({left:Math.max(0,s),behavior:"smooth"}):e.scrollLeft=Math.max(0,s)}export{Oe as cleanup,Fe as mount,je as render};
