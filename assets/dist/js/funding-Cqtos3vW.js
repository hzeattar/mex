import{j as x,l as H,u as Y,v as n,k as p,h as c,m as y,g as l,o as se,c as R,s as ve,n as re,x as $e,i as ke}from"./main-Dum-o8yl.js";const P=globalThis.__MEX_FUNDING_CACHE__||(globalThis.__MEX_FUNDING_CACHE__=new Map),Se=45e3,Ce="/assets/img/payment_methods/",xe=[{name:"Google Pay",file:"pm-google-pay.png"},{name:"Apple Pay",file:"pm-apple-pay.png"},{name:"SII",file:"pm-sii.png"},{name:"American Express",file:"pm-amex.png"},{name:"Mastercard",file:"pm-mastercard.png"},{name:"Visa",file:"pm-visa.png"},{name:"USDT",file:"pm-usdt-networks.png"},{name:"Bank transfer",file:"pm-bank-transfer.png"}];let M=[];const ae=[{key:"deposit",label:"funding.deposit",fallback:"Deposit",icon:p.deposit},{key:"withdraw",label:"funding.withdraw",fallback:"Withdraw",icon:p.withdraw},{key:"history",label:"funding.history",fallback:"History",icon:p.wallet}];function ut(e={}){const t=ge(e),s=x("wallet")||{},r=x("mode")==="real"?"real":"demo",i=!H(),a=t!=="history"&&(r!=="real"||i),o=r==="real"?s.real||{}:s.demo||{};return`
