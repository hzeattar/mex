import{g,e as o,m as v,a as h,b as x,i as P,p as S,n as U,c as $,t as R}from"./main-DC6eObyD.js";import{marketIconPath as j,marketInitial as D}from"./marketIcon-D-Yq8Sis.js";function ne(){const e=g("brand")||{},s=V(),a=g("mode"),n=(g("level")||{}).current||{};return`
  ...
  </div>`}function m(e,s){return`<span><small>${e}</small><strong>${s}</strong></span>`}function B(e){return String(e.side||"buy").toUpperCase()==="SELL"?"SELL":"BUY"}function K(e){const s=e.created_at||e.opened_at||e.open_time||"";if(!s)return"--";const a=typeof s=="number"?s:/^\d+$/.test(String(s))?Number(s):Math.floor(Date.parse(s)/1e3);return Number.isFinite(a)&&a>0?R(a):"--"}function _(e,s,a){return`<div class="hero-metric-card">
