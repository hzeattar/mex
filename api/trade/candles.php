...
// Optimized: reduced budget from 6500ms to 3000ms for faster response
$GLOBALS['CANDLES_REQUEST_BUDGET_MS'] = max(1000, min(5000, (int)env('CANDLES_REQUEST_BUDGET_MS', '3000')));
$GLOBALS['HTTP_GET_JSON_TIMEOUT_OVERRIDE'] = [
  'connect_timeout' => max(1, min(2, (int)env('CANDLES_UPSTREAM_CONNECT_TIMEOUT', '1'))),
  'timeout' => max(2, min(4, (int)env('CANDLES_UPSTREAM_TIMEOUT', '2'))),
  'retries' => max(0, min(0, (int)env('CANDLES_UPSTREAM_RETRIES', '0'))),
];
