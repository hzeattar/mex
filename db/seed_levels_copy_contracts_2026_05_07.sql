...
INSERT INTO invest_plans(id,name,name_en,name_ar,name_ru,desc_en,desc_ar,desc_ru,details_en,details_ar,details_ru,term_days,roi_percent,min_amount,max_amount,risk,payout_schedule,early_exit_allowed,early_exit_penalty_percent,sort_order,status,created_at,updated_at,product_kind,required_level_id,is_perpetual,features_en,features_ar,features_ru,badge_en,badge_ar,badge_ru,headline_en,headline_ar,headline_ru) VALUES
('vp_contract_silver_fx_30','Silver FX Rotation','Silver FX Rotation','Silver FX Rotation','Silver FX Rotation','A 30-day managed FX rotation contract for Silver clients.','A 30-day managed FX rotation contract for Silver clients.','A 30-day managed FX rotation contract for Silver clients.','Majors-only basket, weekly stop review, capped allocation.','Majors-only basket, weekly stop review, capped allocation.','Majors-only basket, weekly stop review, capped allocation.',30,6.8000,750,12000,'medium','end',1,2.0000,22,'active',UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'contract',(SELECT id FROM customer_levels WHERE level_code='silver' LIMIT 1),0,'FX majors\nWeekly risk desk\nSilver badge','FX majors\nWeekly risk desk\nSilver badge','FX majors\nWeekly risk desk\nSilver badge','Silver','Silver','Silver','FX rotation contract','FX rotation contract','FX rotation contract'),
('vp_contract_gold_arab_60','Gold GCC Rotation','Gold GCC Rotation','Gold GCC Rotation','Gold GCC Rotation','A 60-day GCC and commodities blend for Gold clients.','A 60-day GCC and commodities blend for Gold clients.','A 60-day GCC and commodities blend for Gold clients.','Arab equities, gold, and energy exposure with managed exits.','Arab equities, gold, and energy exposure with managed exits.','Arab equities, gold, and energy exposure with managed exits.',60,10.7500,2500,30000,'medium','monthly',1,2.5000,32,'active',UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'contract',(SELECT id FROM customer_levels WHERE level_code='gold' LIMIT 1),0,'GCC basket\nMonthly review\nGold badge','GCC basket\nMonthly review\nGold badge','GCC basket\nMonthly review\nGold badge','Gold','Gold','Gold','Regional growth contract','Regional growth contract','Regional growth contract'),
('vp_contract_platinum_120','Platinum Multi-Asset 120D','Platinum Multi-Asset 120D','Platinum Multi-Asset 120D','Platinum Multi-Asset 120D','A 120-day higher-cap multi-asset contract for Platinum clients.','A 120-day higher-cap multi-asset contract for Platinum clients.','A 120-day higher-cap multi-asset contract for Platinum clients.','Futures, equities, metals, and crypto with priority desk monitoring.','Futures, equities, metals, and crypto with priority desk monitoring.','Futures, equities, metals, and crypto with priority desk monitoring.',120,16.5000,15000,120000,'advanced','monthly',1,2.0000,38,'active',UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'contract',(SELECT id FROM customer_levels WHERE level_code='platinum' LIMIT 1),0,'Priority desk\nHigher caps\nPlatinum badge','Priority desk\nHigher caps\nPlatinum badge','Priority desk\nHigher caps\nPlatinum badge','Platinum','Platinum','Platinum','Advanced multi-asset contract','Advanced multi-asset contract','Advanced multi-asset contract')
ON DUPLICATE KEY UPDATE name=VALUES(name),name_en=VALUES(name_en),name_ar=VALUES(name_ar),name_ru=VALUES(name_ru),desc_en=VALUES(desc_en),desc_ar=VALUES(desc_ar),desc_ru=VALUES(desc_ru),details_en=VALUES(details_en),details_ar=VALUES(details_ar),details_ru=VALUES(details_ru),term_days=VALUES(term_days),roi_percent=VALUES(roi_percent),min_amount=VALUES(min_amount),max_amount=VALUES(max_amount),risk=VALUES(risk),payout_schedule=VALUES(payout_schedule),early_exit_allowed=VALUES(early_exit_allowed),early_exit_penalty_percent=VALUES(early_exit_penalty_percent),sort_order=VALUES(sort_order),status='active',updated_at=UNIX_TIMESTAMP(),product_kind=VALUES(product_kind),required_level_id=VALUES(required_level_id),is_perpetual=VALUES(is_perpetual),features_en=VALUES(features_en),features_ar=VALUES(features_ar),features_ru=VALUES(features_ru),badge_en=VALUES(badge_en),badge_ar=VALUES(badge_ar),badge_ru=VALUES(badge_ru),headline_en=VALUES(headline_en),headline_ar=VALUES(headline_ar),headline_ru=VALUES(headline_ru);
...
INSERT INTO vp_seed_trading_signals(market_symbol,market_type,timeframe,direction,entry_price,stop_loss,take_profit_1,take_profit_2,confidence,source,note_en,note_ar,note_ru,bot_enabled,bot_name_en,bot_name_ar,bot_name_ru,bot_brief_en,bot_brief_ar,bot_brief_ru,copy_min_amount,copy_lock_days,copy_profit_share_pct,copy_leverage,show_on_home,status,valid_until,created_at,updated_at,recommend_count,comments_count) VALUES
('GBPUSD','forex','4h','SELL',0,0,0,0,76,'desk','Sterling pullback signal with majors confirmation.','Sterling pullback signal with majors confirmation.','Sterling pullback signal with majors confirmation.',1,'FX Sterling Desk','FX Sterling Desk','FX Sterling Desk','Tracks GBP liquidity, dollar strength, and volatility windows.','Tracks GBP liquidity, dollar strength, and volatility windows.','Tracks GBP liquidity, dollar strength, and volatility windows.',400,7,9.0000,5,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),48,6),
('USDJPY','forex','1h','BUY',0,0,0,0,78,'desk','Yen momentum continuation with tight desk-managed stop.','Yen momentum continuation with tight desk-managed stop.','Yen momentum continuation with tight desk-managed stop.',1,'Tokyo FX Desk','Tokyo FX Desk','Tokyo FX Desk','Tracks yen trend pressure and macro session risk.','Tracks yen trend pressure and macro session risk.','Tracks yen trend pressure and macro session risk.',420,7,9.5000,5,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),52,7),
('MSFT','stocks','1d','BUY',0,0,0,0,75,'desk','Large-cap tech continuation signal for Microsoft.','Large-cap tech continuation signal for Microsoft.','Large-cap tech continuation signal for Microsoft.',1,'Equity Pulse Microsoft','Equity Pulse Microsoft','Equity Pulse Microsoft','Tracks delayed equity momentum and earnings risk bands.','Tracks delayed equity momentum and earnings risk bands.','Tracks delayed equity momentum and earnings risk bands.',500,10,11.0000,1,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),46,4),
('NVDA','stocks','1d','BUY',0,0,0,0,82,'desk','AI semiconductor momentum basket with elevated risk controls.','AI semiconductor momentum basket with elevated risk controls.','AI semiconductor momentum basket with elevated risk controls.',1,'Equity Pulse NVIDIA','Equity Pulse NVIDIA','Equity Pulse NVIDIA','Uses trend, volume, and volatility filters for delayed equity data.','Uses trend, volume, and volatility filters for delayed equity data.','Uses trend, volume, and volatility filters for delayed equity data.',650,10,12.0000,1,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),63,8),
('XAGUSD','commodities','1h','BUY',0,0,0,0,72,'desk','Silver continuation watch paired with gold volatility.','Silver continuation watch paired with gold volatility.','Silver continuation watch paired with gold volatility.',1,'Metals Silver Desk','Metals Silver Desk','Metals Silver Desk','Tracks silver momentum and metals correlation.','Tracks silver momentum and metals correlation.','Tracks silver momentum and metals correlation.',450,7,10.0000,1,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),35,4),
('NQ_F','futures','1h','BUY',0,0,0,0,80,'desk','Nasdaq futures momentum signal for verified contract clients.','Nasdaq futures momentum signal for verified contract clients.','Nasdaq futures momentum signal for verified contract clients.',1,'Nasdaq Futures Desk','Nasdaq Futures Desk','Nasdaq Futures Desk','Tracks NQ momentum, volatility, and session liquidity.','Tracks NQ momentum, volatility, and session liquidity.','Tracks NQ momentum, volatility, and session liquidity.',750,10,12.0000,2,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),44,6),
('CL_F','futures','1h','SELL',0,0,0,0,73,'desk','Crude futures rejection signal around energy inventory risk.','Crude futures rejection signal around energy inventory risk.','Crude futures rejection signal around energy inventory risk.',1,'Crude Futures Desk','Crude Futures Desk','Crude Futures Desk','Tracks crude futures momentum and energy headline risk.','Tracks crude futures momentum and energy headline risk.','Tracks crude futures momentum and energy headline risk.',650,7,11.0000,2,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),31,4),
('1120','arab','1d','BUY',0,0,0,0,70,'desk','Saudi banking momentum signal with delayed market label.','Saudi banking momentum signal with delayed market label.','Saudi banking momentum signal with delayed market label.',1,'Gulf Banking Desk','Gulf Banking Desk','Gulf Banking Desk','Tracks regional banking liquidity and price confirmation.','Tracks regional banking liquidity and price confirmation.','Tracks regional banking liquidity and price confirmation.',350,7,8.0000,1,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),27,4),
('2010','arab','1d','SELL',0,0,0,0,67,'desk','SABIC range-risk signal with delayed regional pricing.','SABIC range-risk signal with delayed regional pricing.','SABIC range-risk signal with delayed regional pricing.',1,'Gulf Industrials Desk','Gulf Industrials Desk','Gulf Industrials Desk','Tracks regional industrials and commodity-linked pressure.','Tracks regional industrials and commodity-linked pressure.','Tracks regional industrials and commodity-linked pressure.',350,7,8.0000,1,1,'active',UNIX_TIMESTAMP()+604800,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),21,3);
...
WHERE id IN ('vp_contract_starter_30','vp_contract_silver_45','vp_contract_gold_90','vp_contract_vip_private','vp_contract_silver_fx_30','vp_contract_gold_arab_60','vp_contract_platinum_120');
...
WHERE source='desk'
  AND market_symbol IN ('BTCUSDT','ETHUSDT','XAUUSD','EURUSD','AAPL','USOIL','ZN_F','2222','ES_F','GBPUSD','USDJPY','MSFT','NVDA','XAGUSD','NQ_F','CL_F','1120','2010');
